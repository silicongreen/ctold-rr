 ...
 */
class PollVotes extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('poll_question_id, poll_option_id, user_id, school_id', 'numerical', 'integerOnly'=>true),
			array('custom_answer', 'length', 'max'=>255),
			array('created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, poll_question_id, poll_option_id, custom_answer, user_id, created_at, updated_at, school_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PollVotes the static model class
	 */
