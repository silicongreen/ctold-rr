    ...
    <div id="wrapper" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <div id="main_container" class="main_container container_16 clearfix">
            ...
            <div class="flat_area grid_16">
                <h2>Manage School Activities</h2>
            ...
            <?php if(access_check("schoolactivities","add")): ?>
            <div class="flat_area grid_16">
                <button  type="button"  class="light text_only has_text model" id="<?php echo  base_url(); ?>admin/schoolactivities/add/" >
                    <span>Add School Activity</span>
                </button>
            </div> 
            <?php endif; ?>
