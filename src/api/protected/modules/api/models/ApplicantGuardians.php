...
/**
 * This is the model class for table "applicant_guardians".
 *
 * The followings are the available columns in table 'applicant_guardians':
 * @property integer $id
 ...
 */
class ApplicantGuardians extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('school_id, applicant_id, country_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, school_id, applicant_id, first_name, last_name, relation, email, office_phone1, office_phone2, mobile_phone, office_address_line1, office_address_line2, city, state, country_id, dob, occupation, income, education, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ApplicantGuardians the static model class
	 */
