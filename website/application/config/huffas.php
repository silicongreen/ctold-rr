...
$config['api_url'] = 'http://api.champs21.dev/index.php/api/freeuser';
$config['paid_auth_api_url'] = 'http://api.champs21.dev/index.php/api/user/auth';
...
$config['education-changes-life'] = array(
    ...
    'top_banner' => array(
        'title' => '/styles/layouts/tdsfront/image/edu_change_life.png',
        'logo' => '/styles/layouts/tdsfront/image/education-logo.png',
    ),
