<div id="pjax">
    <?php echo form_open('',array('id'=>'channel_form','class' => 'validate_form','enctype'=>'multipart/form-data'));?>
    <?php
        if(isset($values) && !empty($values->id)){
            echo '<input type="hidden" id="Channel_id" name="Channel[id]" value="'.$values->id.'">';
        }
    ?>
    ...
    <div style="padding-top:5px;" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <div id="main_container" class="main_container container_16 clearfix popup">
            ...
            <div class="box grid_16">
                <div class="block">
                    <h2 class="section"><?php echo ($edit) ? "Edit":"Add";?> Channel</h2>
                </div>
            </div>
            ...
            <div class="box grid_16">
                <div class="block">
                    <fieldset class="label_side top">
                        <label for="<?php echo $model.'_'.$fields['name'];?>">Channel Name</label>
                        <div>
