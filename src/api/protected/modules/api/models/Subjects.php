...
class Subjects extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'studentSubject' => array(self::HAS_MANY, 'StudentsSubjects', 'subject_id')
        );
    }
    ...
    public function getSubjectByBatchCode($sub_data,$batch_id)
    {
       $criteria = new CDbCriteria(); 
       $criteria->select = 't.id';
       $criteria->compare('t.code', $sub_data->code);
       $criteria->compare('t.batch_id', $batch_id);
       $subject = $this->find($criteria);
       return $subject;
    }        
