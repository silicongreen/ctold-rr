...
<div id="primary" class="content-area">
	...
	<div class="wrapper">
		...
		<div id="beforeWrap" style="background: transparent url(<?php bloginfo('template_url'); ?>/images/cover/parent-page.png) no-repeat top left;background-size:cover;">
			...
			<h2 class="f2" style="float: right;margin-right: 170px;margin-top: 200px;width: 600px;"><i>যখন যেখানে, যেভাবে প্রয়োজন আপনার সন্তানের অগ্রগতি প্রত্যক্ষ করুন!</i></h2>
