        ...
        if($studentdata->school_id == 356)
        {
            ...
            if($studentdata->sms_number)
            {
                ...
                if ($late == 1)
                    ...
                    $message = "Respected Parents, your child (".$studentdata->first_name . " " . $studentdata->last_name . ") is absent from the online class On (" . $newattendence->month_date."). Rector-BAGHC";
