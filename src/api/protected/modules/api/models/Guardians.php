...
class Guardians extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ward_id, country_id, user_id, school_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, ward_id, first_name, last_name, relation, email, office_phone1, office_phone2, mobile_phone, office_address_line1, office_address_line2, city, state, country_id, dob, occupation, income, education, created_at, updated_at, user_id, school_id', 'safe', 'on'=>'search'),
		);
	}
