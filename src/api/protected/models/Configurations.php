...
class Configurations extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, config_key, config_value, created_at, updated_at, school_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public static function model($className=__CLASS__)
	{
        ...
        public function getConfigId($key,$school_id="")
        {
            $criteria=new CDbCriteria;
            $criteria->compare('config_key',$key);
            if($school_id)
            {
