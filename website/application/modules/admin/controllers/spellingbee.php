...
class spellingbee extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $this->table->set_heading('Word', 'Bangla Meaning', 'Definition', 'Sentence', 'Type', 'Level', 'Status', 'Source', 'Spell Date', 'Action');

        $obj_spell = new Spelling_bee();
        $obj_spell->order_by('Word', 'asc');
        $obj_spell->get();
    ...
    public function datatable()
    {
        ...
        $this->datatables->set_custom_string(6, array(1 => "Easy", 2 => "Medium", 3 => "Hard"));
        $this->datatables->set_custom_string(7, array(0 => "Disabled", 1 => "Enabled"));
        $this->datatables->set_custom_string(8, array(1 => "Word Bank", 2 => "Others", 3 => "Daily Star"));
        
        $this->datatables->select('spellingbee.id as primary_id, spellingbee.word, spellingbee.bangla_meaning, spellingbee.definition, spellingbee.sentence, spellingbee.wtype, spellingbee.level, spellingbee.enabled, spellingbee.source, spellingbee.spell_date')
