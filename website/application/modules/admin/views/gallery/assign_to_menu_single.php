...
<div id="main_container" class="container_16 clearfix">
    <div class="box grid_16" >
        <div style="width: 100px; float: left; text-align: left; ">
            Select Menu: <br />
            <select name="menu" id="menu" style="width: 190px;">
        ...
        <div style="width: 100px; float: left; text-align: left; clear: both; ">
            Date: <br />
            <input id="issue_date" class="datepicker required" required name="issue_date" value="<?php echo date("Y-m-d"); ?>" readonly=""  type="text" >   
        </div>
        <div id="image_box" style="border: 1px solid #d5d5d5; clear: both; overflow: auto; height: 400px; width: 99%; display: none;">
            <br />
    ...
    $(document).ready(function(){
        ...
        $(document).on("click","#assign_menu",function(){
            ...
            $.ajax({
                ...
                async: false,
                success: function(data) {
                    if ( $("#image_box").css("display") == "block" )
                    {
