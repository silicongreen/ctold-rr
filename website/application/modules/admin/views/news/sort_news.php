    ...
    $(function() {
        ...
        $( ".portlet-header .ui-icon" ).click(function() 
        {
            ...
            else
            {
                ...
                $.post('<?php echo base_url();?>admin/news/news_by_category', {category_id: id,tds_csrf: $('input[name$="tds_csrf"]').val()}, function(data){
...
<div id="pjax">
    <div id="wrapper" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <div id="main_container" class="main_container container_16 clearfix">
                ...
                <input style="cursor: pointer;position: fixed;-webkit-transform: translateZ(0); right: 30px; width: 100px; top: 70px; text-align: right; " type="button" name="arrange_category" id="arrange_category" class="arrange_category" value="Save Priority" />
            
            <div class="flat_area grid_16">
                <input type="hidden" name="<?php echo $token_name;?>" value="<?php echo $token_val;?>" />
                <h2>Category News Arrangement</h2>
                <div class="column">
...
<div class="display_none">						
    <div id="dialog_category_arrange" class="dialog_content narrow" title="Arrange">
        <div class="block">
            <div class="section">
                <h1>News Arrangement</h1>
                <div class="dashed_line"></div>	
                <p>Category News has been Successfully Arranged </p>
