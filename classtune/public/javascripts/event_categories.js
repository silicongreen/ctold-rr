...
var TableEditable = function () {
    ...
    var handleTable = function () {
        ...
        {
            var url = "/event/category_update/" + id; // the script where you handle the form input.
            var formData = {
                    'name'  : name
            };
        ...
        {
            var url = "/event/category_add"; // the script where you handle the form input.        
            var formData = {
                    'category_name'  : name
            };
            var insert_id = 0; 
        ...
        {
            var url = "/event/category_delete/" + id; 
            jq.ajax({
                type: "POST",
                url: url
            }).done(function(data) {});
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                editRow(oTable, nRow);
                nEditing = nRow;
            } else if (nEditing == nRow && this.innerHTML == '<i class="glyphicon glyphicon-pencil"></i>Save') {
