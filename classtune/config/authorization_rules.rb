authorization do
  ...
  role :admin do
    ...
    has_permission_on [:other], :to => [:admit_card,:list_students,:print_admit_card,:student_record,:list_student_record,:print_student_record,:excel_student_record,:print_bus_card,:list_student_bus_card,:bus_card]
