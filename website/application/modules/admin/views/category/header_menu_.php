<div id="pjax">
    <div style="padding-top:5px;" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <div id="main_container" class="main_container container_16 clearfix popup">
            ...
            <?php if(access_check("categories","add_pdf")): ?>
            <div class="flat_area grid_16">
                <button  type="button"  class="light text_only has_text model" id="<?php echo  base_url(); ?>admin/categories/add_pdf/<?php echo $category_id?>" >
                    <span>Add pdf</span>
                </button>
            </div>  
            <?php endif; ?>
