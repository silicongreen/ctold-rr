...
/**
 * This is the model class for table "archived_employee_salary_structures".
 *
 * The followings are the available columns in table 'archived_employee_salary_structures':
 * @property integer $id
 ...
 */
class ArchivedEmployeeSalaryStructures extends CActiveRecord
{
	/**
	...
	{
		return 'archived_employee_salary_structures';
	}
	 ...
	 * @return ArchivedEmployeeSalaryStructures the static model class
	 */
