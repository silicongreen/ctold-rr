...
/**
 * This is the model class for table "applicant_addl_attachments".
 *
 * The followings are the available columns in table 'applicant_addl_attachments':
 * @property integer $id
 ...
 */
class ApplicantAddlAttachments extends CActiveRecord
{
	/**
	...
	{
		return 'applicant_addl_attachments';
	}
	...
	public function rules()
	{
		...
		return array(
			array('school_id, applicant_id, attachment_file_size', 'numerical', 'integerOnly'=>true),
			...
			array('id, school_id, applicant_id, attachment_file_name, attachment_content_type, attachment_file_size, created_at, updated_at, attachment_updated_at', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ApplicantAddlAttachments the static model class
	 */
