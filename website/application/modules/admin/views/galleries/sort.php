...
<script>
    $(function() {
        ...
        $("#arrange_category").on("click", function(){
            ...
            $.post('<?php echo base_url();?>admin/galleries/save_priorities', {category_ids: category_ids,tds_csrf: $('input[name$="tds_csrf"]').val()}, function(data){
...
<div id="pjax">
    <div id="wrapper" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <div id="main_container" class="main_container container_16 clearfix">
                ...
                <input type="button" style="cursor: pointer;position: fixed;-webkit-transform: translateZ(0); right: 30px;  top: 70px; text-align: right; " name="arrange_category" id="arrange_category" class="arrange_category" value="Save Priority" />
           
            <div class="flat_area grid_16">
                <input type="hidden" name="<?php echo $token_name;?>" value="<?php echo $token_val;?>" />
                <h2>Gallery Arrangement</h2>
                <div class="column">
                    <?php if ($gallery_name) foreach($gallery_name as $gallery) : ?>
                    <div class="portlet">
                        <div class="portlet-header" id="category_<?php echo $gallery->id;?>">
                            <span class='cat' id="category_<?php echo $gallery->id;?>"></span>
...
<div class="display_none">						
    <div id="dialog_category_arrange" class="dialog_content narrow" title="Arrange">
        <div class="block">
            <div class="section">
                <h1>Gallery Arrangement</h1>
                <div class="dashed_line"></div>	
                <p>Gallery has been Successfully Arranged </p>
                <p>Press The Ok button for continue</p>
            </div>
            <div class="button_bar clearfix">
                <button id="btn_close" class="dark blue no_margin_bottom link_button" data-link="<?= base_url() ?>admin/galleries/sort_galleries/">
