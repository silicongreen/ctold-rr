<!--[if lte IE 8]><script src="<?php echo base_url('styles/layouts/tdsfront/sceincerocks/assets/js/ie/html5shiv.js'); ?>"></script><![endif]-->
    <link rel="stylesheet" href="<?php echo base_url('styles/layouts/tdsfront/sceincerocks/assets/css/main.css?v=1.3'); ?>">
...
<div class="container landing" id="tabContainer" style="width: 100%; min-height: 250px; margin-bottom: -25px;">
   <div id="page-wrapper">
        <!-- Banner -->
                <section id="banner" style="z-index:1;overflow: hidden;">
        ...
        <!-- Main -->
                <section id="main" class="container" style="z-index:3;position: relative;">
...
<script>
    ...
    <script>
        ...
        var vid = [
                                {'videoId': 'P5VcQjKRNys', 'startSeconds': 1, 'suggestedQuality': 'hd720'}
                        ],
