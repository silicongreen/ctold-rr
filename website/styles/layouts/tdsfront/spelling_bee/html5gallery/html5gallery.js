 ...
 */
(function(){
    for(var r=document.getElementsByTagName("script"),p="",l=0;l<r.length;l++)r[l].src&&r[l].src.match(/html5gallery\.js/i)&&(p=r[l].src.substr(0,r[l].src.lastIndexOf("/")+1));
    r=!1;
    if("undefined"==typeof jQuery)r=!0;
    else if(l=jQuery.fn.jquery.split("."),1>l[0]||1==l[0]&&6>l[1])r=!0;
    if(r){
        ...
        s.setAttribute("src",p+"jquery.js");
        r.appendChild(s)
...
function loadHtml5Gallery(r){
    ...
    jQuery.extend(jQuery.easing,{
        ...
        easeInElastic:function(c,e,a,d,b){
            ...
            if(1==(e/=b))return a+d;
            m||(m=0.3*b);
            h<Math.abs(d)?(h=d,c=m/4):c=m/(2*Math.PI)*Math.asin(d/h);
            return-(h*Math.pow(2,10*(e-=1))*Math.sin((e*b-c)*2*Math.PI/m))+a
            },
        easeOutElastic:function(c,
            ...
            m||(m=0.3*b);
            h<Math.abs(d)?(h=d,c=m/4):c=m/(2*Math.PI)*Math.asin(d/h);
            return h*Math.pow(2,-10*e)*Math.sin((e*b-c)*2*Math.PI/m)+d+a
            },
        easeInOutElastic:function(c,e,a,d,b){
            ...
            m||(m=b*0.3*1.5);
            h<Math.abs(d)?(h=d,c=m/4):c=m/(2*Math.PI)*Math.asin(d/h);
            return 1>e?-0.5*h*Math.pow(2,10*(e-=1))*Math.sin((e*b-c)*2*Math.PI/m)+a:0.5*h*Math.pow(2,-10*(e-=1))*Math.sin((e*b-c)*2*Math.PI/
                m)+d+a
            },
...
p.fn.touchSwipe=function(c){
    ...
    return this.each(function(){
        function a(a){
            ...
            (h=b.targetTouches[0].pageX,f=b.targetTouches[0].pageY):c(a)
            }
            function d(a){
            e.preventWebBrowser&&a.preventDefault();
            var b=a.originalEvent;
            1<=b.targetTouches.length?(n=b.targetTouches[0].pageX,y=b.targetTouches[0].pageY):c(a)
            }
            function b(a){
...
l.fn.drag=function(c,e,a){
    var d="string"==typeof c?c:"",b=l.isFunction(c)?c:l.isFunction(e)?e:null;
...
var s=l.event,u=s.special,j=null,j=u.drag={
    defaults:{
        which:1,
        distance:0,
        not:":input",
    ...
    add:function(c){
        ...
        e.related+=1;
        !e.live&&c.selector&&(e.live=!0,s.add(this,"draginit."+j.livekey,j.delegate));
        l.each(j.defaults,function(c){
            void 0!==a[c]&&(e[c]=a[c])
            })
        },
    remove:function(){
...
init:function(c){
    ...
    if(!(0<e.which&&c.which!=e.which)&&!l(c.target).is(e.not)&&(!e.handle||l(c.target).closest(e.handle,c.currentTarget).length))if(e.propagates=1,e.interactions=[j.interaction(this,e)],e.target=c.target,e.pageX=c.pageX,e.pageY=c.pageY,e.dragging=null,a=j.hijack(c,"draginit",e),e.propagates){
        ...
        j.textselect(!1);
        s.add(document,"mousemove mouseup",j.handler,e);
        return!1
        }
    },
...
handler:function(c){
    ...
    switch(c.type){
        ...
        case "mousemove":
            ...
            case "mouseup":
            s.remove(document,"mousemove mouseup",j.handler),e.dragging&&(!1!==e.drop&&u.drop&&u.drop.handler(c,e),j.hijack(c,"dragend",e)),j.textselect(!0),!1===e.click&&e.dragging&&(jQuery.event.triggered=!0,setTimeout(function(){
...
delegate:function(c){
    var e=[],a,d=l.data(this,"events")||{};
    
    l.each(d.live||[],function(b,d){
        if(0===d.preType.indexOf("drag")&&(a=l(c.target).closest(d.selector,c.currentTarget)[0]))s.add(a,d.origType+"."+j.livekey,d.origHandler,d.data),0>l.inArray(a,e)&&e.push(a)
            });
    return!e.length?!1:l(e).bind("dragend."+j.livekey,function(){
        s.remove(this,"."+j.livekey)
        })
    },
hijack:function(c,e,a,d,b){
    if(a){
        var m=c.originalEvent,h=c.type,f=e.indexOf("drop")?"drag":"drop",n,x=d||0,q,g;
        d=!isNaN(d)?
        d:a.interactions.length;
        c.type=e;
        c.originalEvent=null;
        a.results=[];
        do if((q=a.interactions[x])&&!("dragend"!==e&&q.cancelled))g=j.properties(c,a,q),q.results=[],l(b||q[f]||a.droppable).each(function(b,d){
            n=(g.target=d)?s.handle.call(d,c,g):null;
            !1===n?("drag"==f&&(q.cancelled=!0,a.propagates-=1),"drop"==e&&(q[f][b]=null)):"dropinit"==e&&q.droppable.push(j.element(n)||d);
            "dragstart"==e&&(q.proxy=l(j.element(n)||q.drag)[0]);
            q.results.push(n);
            delete c.result;
...
z.fn.html5boxTransition=function(c,e,a,d,b){
    $parent=this;
    c=d.effect;
    var m=d.easing,h=d.duration,f=d.direction,n=null;
    c&&(c=c.split(","),n=c[Math.floor(Math.random()*c.length)],n=z.trim(n.toLowerCase()));
    n&&d[n]&&(d[n].duration&&(h=d[n].duration),d[n].easing&&(m=d[n].easing));
    "fade"==n?(a.show(),e.fadeOut(h,m,function(){
        e.remove();
        b()
        })):"crossfade"==n||"fadeout"==n?(a.hide(),e.fadeOut(h/2,m,
        function(){
            a.fadeIn(h/2,m,function(){
                e.remove();
                b()
                })
            })):"slide"==n?($parent.css({
...
g.fn.addHTML5VideoControls=function(c,e){
    var a="ontouchstart"in window,d=a?"touchstart":"mousedown",b=a?"touchmove":"mousemove",m=a?"touchcancel":
    "mouseup",h=a?"touchstart":"click",f=a?48:36,n=null,x=null,q=!1,j=!0,l=null!=navigator.userAgent.match(/iPod/i)||null!=navigator.userAgent.match(/iPhone/i),r=g(this).data("ishd"),s=g(this).data("hd"),p=g(this).data("src"),k=g(this);
    ...
    setInterval(function(){
        j&&(t.show(),j=!1,clearTimeout(n),n=setTimeout(function(){
    ...
    var H=g(".html5boxPlay",t),I=g(".html5boxPause",t);
    H.css({
        display:"block",
        position:"absolute",
        top:0,
    ...
    var C=g(".html5boxTimeCurrent",t),L=g(".html5boxTimeTotal",
        t),v=g(".html5boxSeeker",t),E=g(".html5boxSeekerPlay",t),M=g(".html5boxSeekerBuffer",t),O=g(".html5boxSeekerHandler",t);
    C.css({
        display:"block",
        position:"relative",
        "float":"left",
    ...
    g(".html5boxHD",t).css({
        ...
        k.get(0).setAttribute("src",(r?s:p)+"#t="+k.get(0).currentTime);
    ...
    if(k.get(0).volume===u/2+0.1){
        k.get(0).volume=u;
        var u=g(".html5boxVolume",t),F=g(".html5boxVolumeButton",t),K=g(".html5boxVolumeBar",t),w=g(".html5boxVolumeBarBg",t),B=g(".html5boxVolumeBarActive",t);
        u.css({
            display:"block",
            position:"relative",
            "float":"right",
        ...
        if(a){
            C.text(N(a));
            var c=k.get(0).duration;
            if(c){
                L.text(N(c));
                var b=v.width(),a=Math.round(b*a/c);
                E.css({
                    width:a
                });
                O.css({
...
c.fn.html5gallery=function(g){
    ...
    e.prototype={
        ...
        init:function(a){
            ...
            a.options.freeversion?a.options.watermarkcode+=a.options.freemark:0<a.options.watermark.length&&
            (a.options.watermarkcode+="<img src='"+a.options.watermark+"' />");
            a.options.watermarkcode+="</div>";
            a.options.watermarkcode+=a.options.freeversion?"</a>":"";
            a.createStyle();
            a.createMarkup();
            a.createImageToolbox();
            0>=a.elemArray.length||(a.createEvents(),a.loadCarousel(),a.savedElem=-1,a.curElem=-1,a.nextElem=-1,a.prevElem=-1,a.isPaused=!a.options.autoslide,a.isFullscreen=!1,a.disableTouchSwipe=!1,d=a.getParams(),a.slideRun(d.html5galleryid&&d.html5galleryid in a.elemArray?d.html5galleryid:0),a.options.responsive&&
                (a.resizeGallery(),c(window).resize(function(){
                    a.resizeGallery()
                    })))
            },
        resizeGallery:function(){
            switch(this.options.skin){
                case "vertical":case "showcase":
        ...
        initData:function(a){
            ...
            if(this.options.src&&0<this.options.src.length){
                ...
                this.elemArray.push([0,"",this.options.src,
                    this.options.webm,this.options.ogg,"","",this.options.title?this.options.title:"",this.options.title?this.options.title:"",d,this.options.width,this.options.height,this.options.poster,this.options.hd,this.options.hdogg,this.options.hdwebm]);
                this.readTags();
                a(this)
                ...
                c.ajax({
                    ...
                    success:function(d){
                        c(d).find("slide").each(function(a){
                            ...
                            b.elemArray.push([c(this).find("id").length?c(this).find("id").text():a,c(this).find("thumbnail").text(),c(this).find("file").text(),c(this).find("file-ogg").text(),c(this).find("file-webm").text(),
                                c(this).find("link").text(),c(this).find("linktarget").text(),d,e,m,c(this).find("width").length&&!isNaN(parseInt(c(this).find("width").text()))?parseInt(c(this).find("width").text()):b.options.width,c(this).find("height").length&&!isNaN(parseInt(c(this).find("height").text()))?parseInt(c(this).find("height").text()):b.options.height,c(this).find("poster").text(),c(this).find("hd").text(),c(this).find("hdogg").text(),c(this).find("hdwebm").text()])
                            });
                        b.readTags();
                        a(b)
                        }
                    })
            }else this.options.remote&&
            0<this.options.remote.length?(b=this,c.getJSON(this.options.remote,function(c){
    ...
    readTags:function(){
        ...
        c("img",this.container).each(function(){
            ...
            b||(b="");
            e||(e="");
            var h=a.options.width,f=a.options.height,n=null,g=null,q=null,j=null,l=null,r=null,s=null,p=null;
            c(this).parent().is("a")&&(d=c(this).parent().attr("href"),n=c(this).parent().data("ogg"),g=c(this).parent().data("webm"),q=c(this).parent().data("link"),
                j=c(this).parent().data("linktarget"),l=c(this).parent().data("poster"),isNaN(c(this).parent().data("width"))||(h=c(this).parent().data("width")),isNaN(c(this).parent().data("height"))||(f=c(this).parent().data("height")),r=c(this).parent().data("hd"),s=c(this).parent().data("hdogg"),p=c(this).parent().data("hdwebm"));
            var k=c(this).parent().data("mediatype")?c(this).parent().data("mediatype"):a.checkType(d);
            a.elemArray.push([a.elemArray.length,c(this).attr("src"),d,n,g,q,j,b,e,k,h,f,l,r,s,p])
            })
        },
    createMarkup:function(){
        ...
        this.options.googleanalyticsaccount&&!window._gaq&&(window._gaq=window._gaq||
            [],window._gaq.push(["_setAccount",this.options.googleanalyticsaccount]),window._gaq.push(["_trackPageview"]),c.getScript(("https:"==document.location.protocol?"https://ssl":"http://www")+".google-analytics.com/ga.js"))
        },
    createSocialMedia:function(){
        ...
        if(this.options.showsocialmedia&&this.options.showfacebooklike){
            var d=
            "<div style='display:block; float:left; width:110px; height:21px;'><iframe src='http://www.facebook.com/plugins/like.php?href=",d=this.options.facebooklikeurl&&0<this.options.facebooklikeurl.length?d+encodeURIComponent(this.options.facebooklikeurl):d+a;
    ...
    c(".html5gallery-car-left-"+this.id,this.$gallery).click(function(){
        c(this).data("disabled")||a.carouselPrev()
        });
...
resizeStyleVertical:function(){
    if(this.container.parent()&&this.container.parent().width()){
        ...
        this.options.width="bottom"==this.options.carouselposition?this.options.totalWidth-2*this.options.padding:
        this.options.totalWidth-(this.options.carouselWidth+this.options.carouselmargin+2*this.options.padding);
        this.options.responsivefullscreen&&0<this.container.parent().height()?(this.options.containerHeight=this.container.parent().height(),this.options.totalHeight=this.options.containerHeight,this.options.height="bottom"==this.options.carouselposition?this.options.totalHeight-(this.options.headerHeight+2*this.options.padding+this.options.carouselheight):this.options.totalHeight-(this.options.headerHeight+
        ...
        if(this.options.showcarousel)if("bottom"==this.options.carouselposition){
            ...
            this.options.thumbshowtitle&&c("head").append("<style type='text/css'>.html5gallery-tn-title-"+
            ...
            20),"left"==this.options.carouselposition?(this.options.boxLeft=this.options.padding+this.options.carouselWidth+this.options.carouselmargin,this.options.carouselLeft=this.options.padding):this.options.carouselLeft=this.options.padding+this.options.width+this.options.carouselmargin,this.options.carouselTop=this.options.padding;
        ...
        if(1==a){
            ...
            }else if(5==a||6==a||7==a||8==a||9==a||10==a)a=this.elemArray[this.curElem][10],d=this.elemArray[this.curElem][11],this.isFullscreen?(b=Math.min(this.fullscreenWidth/a,this.fullscreenHeight/
...
createStyleVertical:function(){
    ...
    "top"==this.options.headerpos?(d=0,a=this.options.socialheight,this.options.elemTop=this.options.headerHeight):
    "bottom"==this.options.headerpos&&(this.options.elemTop=0,a=this.options.titleoverlay?this.options.height-this.options.titleheight:this.options.height,d=this.options.titleoverlay?this.options.height:this.options.height+this.options.titleheight);
    var b=" .html5gallery-container-"+this.id+" { display:block; position:absolute; left:0px; top:0px; width:"+this.options.totalWidth+"px; height:"+this.options.totalHeight+"px; background:url('"+this.options.skinfolder+this.options.bgimage+"') center top; background-color:"+
    ...
    var b=b+(" .html5gallery-box-"+this.id+" {display:block; position:absolute; text-align:center; left:"+this.options.boxLeft+"px; top:"+this.options.boxTop+"px; width:"+this.options.boxWidth+"px; height:"+this.options.boxHeight+"px; }"),e=Math.round(this.options.socialheight/2-12),b=b+(" .html5gallery-title-text-"+
    ...
    if("never"!=this.options.showimagetoolbox){
        ...
        if(this.options.showplaybutton||
            ...
            if("center"==this.options.imagetoolboxstyle){
                ...
                }else this.options.showplaybutton&&1==a?this.isPaused?(c(".html5gallery-play-"+this.id,this.$gallery).show(),c(".html5gallery-pause-"+this.id,this.$gallery).hide()):(c(".html5gallery-play-"+this.id,
...
resizeStyleDefault:function(){
    if(this.container.parent()&&this.container.parent().width()){
        ...
        if(1==a){
            ...
            }else if(5==a||6==a||7==a||8==a||9==a||10==a)a=this.elemArray[this.curElem][10],d=this.elemArray[this.curElem][11],this.isFullscreen?(b=Math.min(this.fullscreenWidth/a,this.fullscreenHeight/d),b=1<b?1:b,a=Math.round(b*
            a),b=Math.round(b*d),this.adjustFullscreen(a,b,!0)):(a=this.options.width,b=this.options.height),c(".html5gallery-elem-"+this.id).css({
            width:a+"px",
            height:b+"px"
            }),c(".html5gallery-elem-video-"+this.id).css({
            width:a+"px",
        ...
        this.options.showcarousel&&(c(".html5gallery-car-"+this.id).css({
            ...
            this.options.thumbShowNum*this.options.thumbgap,this.options.thumbTotalWidth=this.elemArray.length*this.options.thumbwidth+(this.elemArray.length-1)*this.options.thumbgap,d=0,this.options.thumbMaskWidth>this.options.thumbTotalWidth&&(d=this.options.thumbMaskWidth/2-this.options.thumbTotalWidth/2),c(".html5gallery-thumbs-"+this.id).css({
                ...
                2),c(".html5gallery-car-mask-"+this.id).css({
                left:a+"px",
...
createStyleDefault:function(){
    ...
    this.options.showcarousel?(b+=" .html5gallery-car-"+this.id+" { position:absolute; display:block; overflow:hidden; left:"+this.options.carouselLeft+"px; top:"+this.options.carouselTop+"px; width:"+this.options.width+"px; height:"+this.options.carouselHeight+"px;",b=this.options.carouselbgtransparent?b+"background-color:transparent;":b+("border-top:1px solid "+this.options.carouseltopborder+";border-bottom:1px solid "+this.options.carouselbottomborder+";background-color: "+this.options.carouselbgcolorend+
        ...
        b+=" .html5gallery-tn-img-"+this.id+" {display:block; overflow:hidden; width:"+String(this.options.thumbimagewidth+2*this.options.thumbimageborder)+"px;height:"+String(this.options.thumbimageheight+2*this.options.thumbimageborder)+"px;}",this.options.thumbunselectedimagebordercolor&&(b+=" .html5gallery-tn-selected-"+this.id+" {background-color:"+this.options.thumbunselectedimagebordercolor+";}"),this.options.thumbshowtitle?(b+=" .html5gallery-tn-title-"+this.id+" {display:block; overflow:hidden; float:top; height:"+
            ...
            c("#html5gallery-tn-"+this.id+"-"+a,this.$gallery).removeClass("html5gallery-tn-"+this.id).addClass("html5gallery-tn-selected-"+this.id);
            if(this.options.thumbShowNum>=this.elemArray.length)c(".html5gallery-car-left-"+
    ...
    for(var b=0;b<this.elemArray.length;b++){
        ...
        c(e).load(function(){
            ...
            c("#html5gallery-tn-"+a.id+"-"+
                ...
                b+"px !important;' src='"+a.elemArray[this.data][1]+"' /></div>"+m+"</div><div class='html5gallery-tn-title-"+a.id+"'>"+a.elemArray[this.data][7]+(a.options.thumbshowdescription?"<br /><span class='html5gallery-tn-description-"+a.id+"'>"+a.elemArray[this.data][8]+"</span>":"")+"</div>")
            });
...
resizeFullscreen:function(){
    ...
    c(".html5gallery-fullscreen-box-"+this.id).css({
        top:d+"px"
        })
    },
goFullscreen:function(){
    ...
    var n=c(".html5gallery-elem-"+this.id,this.$gallery).empty().css({
        top:0
    });
...
slideRun:function(a,d,b,e){
    ...
    if(!(0>a)){
        ...
        (5==a||6==a||7==a||8==a||9==a||10==
            a)&&!b&&this.elemArray[this.curElem][12]?(h=!0,this.showPoster()):(c(".html5gallery-video-play-"+this.id,f).length&&c(".html5gallery-video-play-"+this.id,f).remove(),1==a?this.showImage():5==a||6==a||7==a||8==a?this.showVideo(b,e):9==a?this.showYoutube(b):10==a?this.showVimeo(b):2==a&&this.showSWF());
        this.prevElem in this.elemArray&&1==this.elemArray[this.prevElem][9]&&((new Image).src=this.elemArray[this.prevElem][2]);
        this.nextElem in this.elemArray&&1==this.elemArray[this.nextElem][9]&&((new Image).src=
            this.elemArray[this.nextElem][2]);
        ...
        var n=this;
        if((1==a||h)&&!this.isPaused&&1<this.elemArray.length&&(!this.options.loop||this.looptimes<this.options.loop))this.slideshowTimeout=
            setTimeout(function(){
                n.slideRun(-1)
...
showImage:function(){
    ...
    c(b).load(function(){
        ...
        var f=d.isFullscreen?e:d.options.width,n=d.isFullscreen?b:d.options.height,g=Math.round(f/2-e/2),
        j=Math.round(n/2-b/2);
        ...
        e=c("<div class='html5gallery-elem-img-"+d.id+"' style='display:block; position:absolute; overflow:hidden; width:"+f+"px; height:"+n+"px; left:0px; margin-left:"+(d.options.slideshadow&&!d.isFullscreen?4:0)+"px; top:0px; margin-top:"+(d.options.slideshadow&&!d.isFullscreen?4:0)+"px;'><img class='html5gallery-elem-image-"+d.id+"' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:"+
            g+"px; top:"+j+"px; max-width:none; max-height:none; width:"+e+"px; height:"+b+"px;' src='"+d.elemArray[d.curElem][2]+"' />"+d.options.watermarkcode+"</div>");
...
showPoster:function(){
    ...
    c(f).load(function(){
        ...
        var r=Math.round(g/2-l/2),s=Math.round(j/2-f/2);
        ...
        j.length?(d.prepend(g),d.html5boxTransition(b.id,j,g,{
...
showVideo:function(a,
    ...
    if(this.options.isIE678||this.options.isIE9&&this.options.useflashonie9||this.options.isIE10&&this.options.useflashonie10||
        this.options.isIE11&&this.options.useflashonie11)this.isHTML5=!1;
    ...
    if(this.isHTML5){
        ...
        if(this.options.isFirefox||
            this.options.isOpera||!g)g=this.elemArray[this.curElem][4]?this.elemArray[this.curElem][4]:this.elemArray[this.curElem][3],j=this.elemArray[this.curElem][15]?this.elemArray[this.curElem][15]:this.elemArray[this.curElem][14];
        this.embedHTML5Video(c(".html5gallery-elem-video-"+this.id,b),e,h,g,j,a,f,d)
        }else f=this.elemArray[this.curElem][2],"/"!=f.charAt(0)&&("http:"!=f.substring(0,5)&&"https:"!=f.substring(0,6))&&(f=this.options.htmlfolder+f),g="",this.elemArray[this.curElem][13]&&(g=this.elemArray[this.curElem][13],
        "/"!=g.charAt(0)&&("http:"!=g.substring(0,5)&&"https:"!=g.substring(0,6))&&(g=this.options.htmlfolder+g)),this.embedFlash(c(".html5gallery-elem-video-"+this.id,b),"100%","100%",this.options.jsfolder+"html5boxplayer.swf","transparent",{
        width:e,
        height:h,
        videofile:f,
        hdfile:g,
...
showSWF:function(){
    var a=
    this.isFullscreen?this.$fullscreen:this.$gallery,d=this.elemArray[this.curElem][10],b=this.elemArray[this.curElem][11];
    ...
    c(".html5gallery-elem-"+this.id,a).html("<div class='html5gallery-elem-flash-"+
        this.id+"' style='display:block;position:absolute;overflow:hidden;top:"+e+"px;left:"+h+"px;width:"+d+"px;height:"+b+"px;'></div>"+this.options.watermarkcode);
...
prepareYoutubeHref:function(a){
    ...
    var b=!0,e;
    for(e in a)b?(c+="?",b=!1):c+="&",c+=e+"="+a[e];return c
    },
...
showYoutube:function(a){
    ...
    if(ASYouTubeIframeAPIReady&&!this.options.isIOS&&!this.options.isIE6&&!this.options.isIE7){
        ...
        var g=this.getYoutubeParams(this.elemArray[this.curElem][2]),g=c.extend({
            autoplay:a?1:0,
            rel:0,
            wmode:"transparent"
        },g);
...
}else h=this.prepareYoutubeHref(h),a&&(h=0>h.indexOf("?")?h+"?autoplay=1":h+"&autoplay=1"),h=0>h.indexOf("?")?h+"?wmode=transparent&rel=0":h+"&wmode=transparent&rel=0",c("#html5gallery-elem-video-"+this.id,d).html("<iframe width='"+b+"' height='"+e+"' src='"+h+"' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
this.options.googleanalyticsaccount&&window._gaq.push(["_trackEvent","Video","Play",this.elemArray[this.curElem][7]])
},
...
embedHTML5Video:function(a,d,b,e,h,f,g,j){
    ...
    (f||j)&&c("video",a).get(0).play();
    var l=this;
    c("video",a).unbind("ended").bind("ended",
        function(){
            l.onVideoEnd();
...
embedFlash:function(a,d,b,e,h,f){
    if(this.options.flashInstalled){
        ...
        d="";
        for(var j in g)d+=j+"="+g[j]+" ";a.html("<embed "+d+"/>")
...
this.each(function(){
    ...
    for(var d in g)d.toLowerCase()!==d&&(g[d.toLowerCase()]=g[d],delete g[d]);this.options=c.extend({},g);
    var b=this;
    ...
    var j={
        ...
        freelink:"",
        watermark:""
    },q="vertical"==this.options.skin?c.extend(q,l):"showcase"==this.options.skin?c.extend(q,s):"light"==this.options.skin?c.extend(q,j):"gallery"==this.options.skin?c.extend(q,h):"horizontal"==this.options.skin?c.extend(q,d):"darkness"==this.options.skin?c.extend(q,f):c.extend(q,d);
    ...
    d=c(window).width();
    if(this.options.screenquery)for(var p in this.options.screenquery)d<=this.options.screenquery[p].screenwidth&&(this.options.screenquery[p].gallerywidth&&
        (this.options.width=this.options.screenquery[p].gallerywidth),this.options.screenquery[p].galleryheight&&(this.options.height=this.options.screenquery[p].galleryheight),this.options.screenquery[p].thumbwidth&&(this.options.thumbwidth=this.options.screenquery[p].thumbwidth),this.options.screenquery[p].thumbheight&&(this.options.thumbheight=this.options.screenquery[p].thumbheight));p=new e(a,this.options,C++);
...
var html5GalleryObjects=new function(){
    ...
    this.setHd=function(r,p,l){
        this.objects[r].setHd(p,l)
        };
        
    this.gotoSlide=function(r,p){
        "undefined"===typeof p&&(p=0);
        this.objects[p]&&this.objects[p].slideRun(r)
        }
    };
