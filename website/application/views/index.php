    ...
    <div class="wrapper">
                ...
                <div id="boxesBG">
                    <div class="row1">
                        <div id="box_107" class="box">
                            <img title="" alt="" src="<?php echo base_url(); ?>images/aboutus/1.png" width="100%">
                        ...
                        <div id="box_105" class="box">
                            <img title="" alt="" src="<?php echo base_url(); ?>images/aboutus/2.png" width="100%">
                            <div style="height:120px;backgound:#EFF2F3;">
                        ...
                        <div id="box_103" class="box lastinrow">
                            <img title="" alt="" src="<?php echo base_url(); ?>images/aboutus/3.png" width="100%">
                            <div style="height:120px;backgound:#EFF2F3;">
        ...
        <div id="beforeWrap">
            <div class="owl-carousel">
				...
				<!--div class="item bettlink" style="background-image: url(<?php echo base_url(); ?>images/cover/bett-banner.jpg);cursor:pointer;">
					<div class="slider-inner">
						<div class="container" style="width:100%;">
							<div class="row">
								<div class="col-sm-12">
        ...
        <div id="cronWrap" style="background-color:#F4FAFA;background-image:none;height:800px;">
			<div style="border: 0 solid #ccc;left: 50%;margin: 0 0 0 -499px;position: absolute;width: 1000px;padding:55px 10px 0;">
					...
					<ul class="slides">
							...
							<div class="col-sm-12" style="height:300px;width:1000px;">								
                                                                ...
                                                                <div class="col-sm-4" style="text-align:-moz-center;">
                                                                    <div class="thumbnail-item" style="background-color: transparent;">
                                                                        <a href="#"><img class="img-responsive" src="<?php echo base_url(); ?>slider/new/attendance.png" style="width:300px;" /></a>
                                                                        <div class="tooltip">
                                                                            <img src="<?php echo base_url(); ?>slider/new/attendance.png" alt="" style="width:100%;" />
                                                                        </div> 
                                                                    </div>
								</div>
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										<div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/attandance.png) no-repeat center;"></div>
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#67B270;"><i>Attendance</i></p></div>
									</div>
									...
									<p>
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#67B270;">See attendance of your entire school at one platform.</h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										<div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/academic_calender.png) no-repeat center;"></div>
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#4ECAF0;"><i>Academic Calendar</i></p></div>
									</div>
									...
									<p>
										Upload your academic calendar and make it visible to everyone related. Help everyone to plan for future. Post academic calendar at the beginning of the year with flexibility of modification as and when required.
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#4ECAF0;">All important dates are at your finger tips.</h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										<div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/lesson_paln-white.png) no-repeat center;"></div>
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#AA7B7B;"><i>Lesson Plan</i></p></div>
									</div>
									...
									<p>
										Lesson plan will be available online and modify when required. Facilitate to trace lesson plan against academic calendar.    
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#AA7B7B;">Updated lesson plan for school’s convenience.</h3>
									</div>									
								</div>								
							</div>		
						</li>
							...
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										...
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#D95FC4;"><i>Teacher’s Routine</i></p></div>
									</div>
									...
									<p>
										Upload Teacher’s routine for their convenience and better productivity. Keep an eye on daily and weekly routine of an individual teacher. 
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#D95FC4;">Uploaded Teacher’s routine for their convenience. </h3>
									</div>									
								</div>								
							</div>		
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										<div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/homework.png) no-repeat center;"></div>
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#D994DB;"><i>Homework</i></p></div>
									</div>
									...
									<p>
										Check out homework of a student, a particular class section or whole school at one platform. 
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#D994DB;">Flexibility to check every class’s homework.</h3>
									</div>									
								</div>								
							</div>	
						</li>
							...
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										...
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#F0282F;"><i>Fees</i></p></div>
									</div>
									...
									<p>
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#F0282F;">Hassle free fees collection.</h3>
									</div>									
								</div>								
							</div>
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										<div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/defult.png) no-repeat center;"></div>
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#1E99D5;"><i>Forms</i></p></div>
									</div>
									...
									<p>
										Upload all the necessary forms of your school so that whoever needs it, can download and use. Lessen the queues in the office room and attain higher efficiency in administration.
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#1E99D5;">All necessary forms available online.</h3>
									</div>									
								</div>								
							</div>	
						</li>
							...
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										...
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#73D8BA;"><i>Meeting Request</i></p></div>
									</div>
									...
									<p>
										How important it is to meet with all teachers and parents! Set meetings easily now and even modify for any sudden changes. Organize Parents’ Meet and notify them quickly. 
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#73D8BA;">Call for a meeting is so easy now! </h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										<div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/report_card.png) no-repeat center;"></div>
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#8C93B5;"><i>Report Card</i></p></div>
									</div>
									...
									<p>
										Class Tests, Exam Reports and Project Reports are now available absolutely in digital format. It will also serve as your archive. Create, customize, develop, and distribute report cards like never before.
                                                                        ...
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#8C93B5;">Online Archive of Report Cards </h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    <div class="col-sm-12">
                                                                            ...
                                                                            <div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#BED877;"><i>Events</i></p></div>
                                                                    </div>
                                                                    ...
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#BED877;">One platform for all event updates!</h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>	
                                                <li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    <div class="col-sm-12">
                                                                            <div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/transport.png) no-repeat center;"></div>
                                                                            <div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#F9B047;"><i>Transport</i></p></div>
                                                                    </div>
                                                                    ...
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#F9B047;">See transport schedule</h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>	
                                                <li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    <div class="col-sm-12">
                                                                            <div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/class_routine.png) no-repeat center;"></div>
                                                                            <div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#AF88B4;"><i>Routine</i></p></div>
                                                                    </div>
                                                                    ...
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#AF88B4;">Upload routine with the flexibility of modification</h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>	
                                                <li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    <div class="col-sm-12">
                                                                            <div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/sylabus.png) no-repeat center;"></div>
                                                                            <div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#D3658A;"><i>Syllabus</i></p></div>
                                                                    </div>
                                                                    ...
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#D3658A;">Upload your school’s yearly syllabus</h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>	
                                                <li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    <div class="col-sm-12">
                                                                            <div class="col-sm-4" style="width: 60px;	height: 60px;	border-radius: 30px;	-webkit-border-radius: 30px;	-moz-border-radius: 30px;	background: #64B846 url(<?php echo base_url(); ?>images/dashpallete/notice.png) no-repeat center;"></div>
                                                                            <div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#81C2D6;"><i>Notice</i></p></div>
                                                                    </div>
                                                                    ...
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#81C2D6;">Circulate your notices instantly</h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>	
                                                    ...
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    <div class="col-sm-12">
                                                                            ...
                                                                            <div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;color:#9BA280;"><i>Leave</i></p></div>
                                                                    </div>
                                                                    ...
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;color:#9BA280;">Easy to make and approve leave applications</h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>
				...
				<div id="carousel" class="flexslider">
				    <ul class="slides">
						<li>
						<img src="<?php echo base_url(); ?>slider/thumb/Attendance.png" style="width:140px;padding:5px;" />
						</li>
						<li>
						<img src="<?php echo base_url(); ?>slider/thumb/academic_calendar.png" style="width:140px;padding:5px;"  />
						</li>
						<li>
						<img src="<?php echo base_url(); ?>slider/thumb/Lesson_Plan.png" style="width:140px;padding:5px;"  />
						</li>
						<li>
						<img src="<?php echo base_url(); ?>slider/thumb/Teachers_Routine.png" style="width:140px;padding:5px;"  />
						</li>
						<li>
							<img src="<?php echo base_url(); ?>slider/thumb/Homework.png" style="width:140px;padding:5px;"  />
						</li>
						<li>
							<img src="<?php echo base_url(); ?>slider/thumb/Fees.png" style="width:140px;padding:5px;"  />
						</li>						
						<li>
							<img src="<?php echo base_url(); ?>slider/thumb/Forms.png" style="width:140px;padding:5px;"  />
						</li>
						<li>
							<img src="<?php echo base_url(); ?>slider/thumb/Meeting_Request.png" style="width:140px;padding:5px;"  />
						</li>
						<li>
							<img src="<?php echo base_url(); ?>slider/thumb/Report_Card.png" style="width:140px;padding:5px;"  />
						</li>
						<li>
							<img src="<?php echo base_url(); ?>slider/thumb/Event.png" style="width:140px;padding:5px;"  />
						</li>
                                                <li>
							<img src="<?php echo base_url(); ?>slider/thumb/Transport.png" style="width:140px;padding:5px;"  />
						</li>
                                                <li>
							<img src="<?php echo base_url(); ?>slider/thumb/Routine.png" style="width:140px;padding:5px;"  />
						</li>
                                                <li>
							<img src="<?php echo base_url(); ?>slider/thumb/Syllabus.png" style="width:140px;padding:5px;"  />
						</li>
                                                <li>
							<img src="<?php echo base_url(); ?>slider/thumb/Notice.png" style="width:140px;padding:5px;"  />
						</li>
                                                <li>
							<img src="<?php echo base_url(); ?>slider/thumb/Leave.png" style="width:140px;padding:5px;"  />
						</li>
