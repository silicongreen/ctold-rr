...
function(t, e, i, s) {
    var o = t.GuestChatModel = Backbone.Model.extend({
        ...
        lastTypingUpdate: 0,
        initialize: function() {
            this.once("operators:online", this.manageConnection, this),this.once('operators:maxconnection', this.manageConnectionMax, this), this.on("messages:new", this.storeMessages, this), this.on("messages:new", this.confirmMessagesRead, this)
        },
        autoLogin: function() {
            var t = this;
        ...
        checkOperators: function() {
            ...
            e.get(i.isOperatorOnlinePath, function(e) {
                ...
                else if(e.maxconnection)
                {
                   
                    t.trigger('operators:maxconnection');
                }
                else
                {
...
function(t, e, i) {
    var s = t.WidgetView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            }), this.$window = e(window), this.$html = e("html"), this.$header = this.$(".customer-chat-header"), this.$title = this.$(".customer-chat-header-title"), this.$mobileTitle = e("#mobile-widget i"), this.$toggleBtn = this.$("#customer-chat-button-toggle"), this.$settingsBtn = this.$("#customer-chat-button-settings"), this.$settings = this.$(".customer-chat-header-menu"), this.$typingInfo = this.$(".typing-indicator"), this.$emoticons = this.$(".customer-chat-emots-menu"), this.$input = this.$("#customer-chat-message-input"), this.$contactName = this.$("#customer-chat-contact-name"), this.$contactMail = this.$("#customer-chat-contact-mail"), this.$contactMessage = this.$("#customer-chat-contact-message"), this.$loginName = this.$("#customer-chat-login-name"), this.$loginMail = this.$("#customer-chat-login-mail"), this.$info = this.$("#customer-chat-info-text"), this.$toggleSound = this.$(".customer-chat-toggle-sound"), this.$toggleScroll = this.$(".customer-chat-toggle-scroll"), this.$toggleEmots = this.$(".customer-chat-toggle-emots"), this.$toggleShow = this.$(".customer-chat-toggle-show"), this.$endChat = this.$("#customer-chat-action-end-chat"), this.$endChatConfirmation = this.$("#customer-chat-action-end-chat-confirmation"), this.$endChatConfirm = this.$("#customer-chat-action-end-chat-confirm"), this.showLoading(), this.model.once("operators:online", this.autoLogin, this),this.model.once("operators:maxconnection", this.showMaxConnection, this), this.model.once("operators:offline", this.showContact, this), this.model.once("operators:online", function() {
                 this.postMessage("show"), this.initialized = !0
                
            }, this), this.model.once("operators:maxconnection", function() {
        ...
        setState: function(e) {
            if (this.state != e) switch (this.state = e, this.$settings.hide(), this.$emoticons.hide(), this.$el.removeClass("login-form chat-box contact-form loading-screen info-screen"), e) {
                ...
                case "maxconnection":
                    ...
                    this.$('#contact_max_connection_info').html(i.ui.maxConnectionInfo)
                    break;
                case "contact":
                    this.$el.addClass("contact-form"), this.$title.html(i.ui.contactHeader), this.fullscreenOff(), this.prevState = e;
                    break;
...
function(t, e, i) {
    t.WidgetFacade = function() {
        ...
        }, this).once("operators:maxconnection", function() {
