...
// assign heights to all expandable elements
            ...
            var d = b === g.length - 1 ? f : e, j = h[b], k = i[b], l = d - (j - k);// subtract the margin/padding
...
// NOTE: should use clientLeft/clientTop, but very unreliable cross-browser.
    function o(a, b) {
        ...
        return{left: e, right: e + a[0].clientWidth, // clientWidth includes padding but NOT scrollbars
...
// NOTE: should use clientLeft/clientTop, but very unreliable cross-browser.
    function q(a) {
        var b = a.innerWidth() - a[0].clientWidth, c = {left: 0, right: 0, top: 0, bottom: a.innerHeight() - a[0].clientHeight};// is the scrollbar on the left side?
...
// TODO: move to date section?
    function I(a, b) {
        var c, d, e, f, g = a.start, h = a.end, i = b.start, j = b.end;// in bounds at all?
...
//    parseZone - if there is zone information, should we force the zone of the moment?
    function ia(c, d, e) {
        var f, g, h, i, j = c[0], k = 1 == c.length && "string" == typeof j;// flag for extended functionality
// clone it
// "parsing" is required
...
// -----------------------------------------------------------------------------------
                Ra.call(N, O);
        var R, S, T, U, W, X, Y, Z, $ = N.isFetchNeeded, _ = N.fetchEvents, aa = c[0], ba = {}, ca = 0, da = [];// unzoned
// Main Rendering
// -----------------------------------------------------------------------------------
...
// the fetcher returned a new source. process it
            ...
            var i = b.events;
            if (i)
                a.isFunction(i) ? (H.pushLoading(), i.call(H, // this, the Calendar object
                        I.clone(), M.clone(), c.timezone, function (a) {
                    d(a), H.popLoading()
                })) : a.isArray(i) ? d(i) : d();
            else {
                var j = b.url;
...
// and not affect the passed-in object.
                    var o = a.extend({}, k || {}), p = _(b.startParam, c.startParam), q = _(b.endParam, c.endParam), r = _(b.timezoneParam, c.timezoneParam);
                    p && (o[p] = I.format()), q && (o[q] = M.format()), c.timezone && "local" != c.timezone && (o[r] = c.timezone), H.pushLoading(), a.ajax(a.extend({}, Ab, b, {data: o, success: function (b) {
                            b = b || [];
...
// make a boolean hash as to whether the event occurs on each day-of-week
                    if (f = b.dow)
                        for (e = {}, g = 0; g < f.length; g++)
                            e[f[g]] = !0;// holds the date of the current day
                    for (
// iterate through every day in the current range
                            h = c.clone().stripTime(); h.isBefore(d); )
...
// normalize zero-length deltas to be null
            return e && !e.valueOf() && (e = null), f && !f.valueOf() && (f = null), a.each(b, function (b, j) {
                ...
                k = {start: j.start.clone(), end: j.end ? j.end.clone() : null, allDay: j.allDay}, a.each(g, function (a) {
                    k[a] = j[a]
                }), l = {start: j._start, end: j._end, allDay: d}, u(l), c ? l.end = null : f && !l.end && (l.end = H.getDefaultEventEnd(l.allDay, l.start)), e && (l.start.add(e), l.end && l.end.add(e)), f && l.end.add(f), h && !l.allDay && (e || f) && (l.start.stripZone(), l.end && l.end.stripZone()), a.extend(j, g, l), Sa(j), i.push(function () {
                    a.extend(j, k), Sa(j)
                })
            }), function () {
...
// Abuse of our event system :(
        function z(b) {
            var d, e = c.businessHours, f = {className: "fc-nonbusiness", start: "09:00", end: "17:00", dow: [1, 2, 3, 4, 5], // monday - friday
...
// Determines if the given event can be relocated to the given span (unzoned start/end with other misc data)
        function A(a, b) {
            var d = b.source || {}, e = _(b.constraint, d.constraint, c.eventConstraint), f = _(b.overlap, d.overlap, c.eventOverlap);
            return D(a, e, f, b)
        }
...
// updates the "backup" properties, which are preserved in order to compute diffs later on.
    ...
    var Ta = a.fullCalendar = {version: "2.7.1", internalApiVersion: 3}, Ua = Ta.views = {};
    Ta.isTouch = "ontouchstart"in document, a.fn.fullCalendar = function (b) {
        var c = Array.prototype.slice.call(arguments, 1), d = this;// what this function will return (this jQuery object by default)
...
// Logic for determining if, when the element is right-to-left, the scrollbar appears on the left side
    ...
    var Xa = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], Ya = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"];/* Logging and Debug
     ----------------------------------------------------------------------------------------------------------------------*/
    Ta.log = function () {
...
// addition formatting tokens we want recognized
    ...
    Ta.formatRange = qa;
    var gb = {Y: "year", M: "month", D: "day", // day of month
        d: "day", // day of week
...
// Can be called with another class, or a plain object hash containing new members.
    ...
    var ib = Ta.EmitterMixin = {callbackHash: null, on: function (a, b) {
         ...
         */
            listenTo: function (b, c, d) {
                if ("object" == typeof c)// given dictionary of callbacks
                    ...
                    "string" == typeof c && b.on(c + "." + this.getListenerNamespace(), // use event namespacing to identify this object
                            a.proxy(d, this))
            }, /*
        ...
        return c
    }(), kb = va.extend(jb, {isHidden: !0, options: null, el: null, // the container element for the popover. generated by this object
...
// TODO: better code reuse for this. Repeat code
        ...
        }}), lb = Ta.CoordCache = va.extend({els: null, // jQuery set (assumed to be siblings)
...
// arrays of coordinates (offsets from topleft of document)
        lefts: null, rights: null, tops: null, bottoms: null, constructor: function (b) {
...
// Gets the height of the element at the given index
        ...
        }}), mb = Ta.DragListener = va.extend(jb, {options: null,
// for IE8 bug-fighting behavior
        subjectEl: null, subjectHref: null,
// coordinates of the initial mousedown
        originX: null, originY: null, scrollEl: null, isInteracting: !1, isDistanceSurpassed: !1, isDelayEnded: !1, isDragging: !1, isTouch: !1, delay: null, delayTimeoutId: null, minDistance: null, constructor: function (a) {
            this.options = a || {}
        },
...
// -----------------------------------------------------------------------------------------------------------------
        bindHandlers: function () {
            var b = this, c = 1;
            this.isTouch ? (this.listenTo(a(document), {touchmove: this.handleTouchMove, touchend: this.endInteraction, touchcancel: this.endInteraction,
...
// touchend will continue to be broken until user does a shorttap/scroll, but this is best we can do.
                ...
                }}), this.scrollEl && this.listenTo(this.scrollEl, "scroll", this.handleTouchScroll)) : this.listenTo(a(document), {mousemove: this.handleMouseMove, mouseup: this.endInteraction}), this.listenTo(a(document), {selectstart: z, // don't allow selection while dragging
                contextmenu: z})
...
// extraOptions ignored if drag already started
        startDrag: function (a, b) {
            ...
            var b, c = v(a) - this.originX, d = w(a) - this.originY, e = this.minDistance;// current distance from the origin, squared
...
// This function gets called during every iteration of the scrolling animation loop
        scrollIntervalFunc: function () {
            var a = this.scrollEl, b = this.scrollIntervalMs / 1e3;// considering animation frequency, what the vel should be mult'd by
...
// Gets the hit underneath the coordinates for the given mouse event
        ...
        }}), ob = va.extend(jb, {options: null, sourceEl: null, // the element that will be cloned and made to look like it is dragging
...
// Show the tracking element after it has been temporarily hidden
        ...
        }}), pb = Ta.Grid = va.extend(jb, {view: null, // a View object
...
// TODO: port isTimeScale into same system?
        largeUnit: null, dayDragListener: null, segDragListener: null, segResizeListener: null, externalDragListener: null, constructor: function (a) {
...
// Binds DOM handlers to elements that reside outside the grid, such as the document
        bindGlobalHandlers: function () {
            this.listenTo(a(document), {dragstart: this.externalDragStart, // jqui
...
// For day clicking and selecting.
        buildDayDragListener: function () {
            var a, b, c = this, d = this.view, e = d.opt("selectable"), f = this.dayDragListener = new nb(this, {scroll: d.opt("dragScroll"), interactionStart: function () {
                    a = f.origHit
                }, dragStart: function () {
                    d.unselect()
...
// custom hooks per-type
            var c = this[a + "SegClasses"], d = this[a + "SegCss"], e = c ? c.call(this, b) : [], f = ca(d ? d.call(this, b) : {});
            return"<" + this.fillSegTag + (e.length ? ' class="' + e.join(" ") + '"' : "") + (f ? ' style="' + f + '"' : "") + " />"
        }, /* Generic rendering utilities for subclasses
         ------------------------------------------------------------------------------------------------------------------*/
// Computes HTML classNames for a single-day element
        getDayClasses: function (a) {
            var b = this.view, c = b.calendar.getNow(), d = ["fc-" + Xa[a.day()]];
...
// Generic enough to work with any type of Grid.
        buildSegDragListener: function (a) {
            var b, c, d, e = this, f = this.view, i = f.calendar, j = a.el, k = a.event, l = this.segDragListener = new nb(f, {scroll: f.opt("dragScroll"), subjectEl: j, subjectCenter: !0, interactionStart: function (d) {
                    b = !1, c = new ob(a.el, {additionalClass: "fc-dragging", parentEl: f.el, opacity: l.isTouch ? null : f.opt("dragOpacity"), revertDuration: f.opt("dragRevertDuration"), zIndex: 2}), c.hide(), c.start(d)
...
// DOES NOT consider overlap/constraint.
        computeEventDrop: function (a, b, c) {
            var d, e, f = this.view.calendar, g = a.start, h = b.start;// zoned event date properties
...
// Called when a jQuery UI drag starts and it needs to be monitored for dropping
        listenToExternalDrag: function (a, b, c) {
            var d, e = this, f = this.view.calendar, i = Fa(a), j = e.externalDragListener = new nb(this, {interactionStart: function () {
...
// DOES NOT consider overlap/constraint.
        computeExternalDrop: function (a, b) {
            var c = this.view.calendar, d = {start: c.applyTimezone(a.start), // simulate a zoned event start date
                end: null};
...
// Generic enough to work with any type of Grid.
        buildSegResizeListener: function (a, b) {
            var c, d, e = this, f = this.view, i = f.calendar, j = a.el, k = a.event, l = i.getEventEnd(k), m = this.segResizeListener = new nb(this, {scroll: f.opt("dragScroll"), subjectEl: j, interactionStart: function () {
                    c = !1
...
// Can accept an event "location" as well (which only has start/end and no allDay)
        eventToRange: function (a) {
            return{start: a.start.clone().stripZone(), end: (a.end ? a.end.clone() :
...
// Slices up a date range into a segment for every week-row it intersects with
        sliceRangeByRow: function (a) {
            var b, c, d, e, f, g = this.daysPerRow, h = this.view.computeDayRange(a), i = this.getDateDayIndex(h.start), j = this.getDateDayIndex(h.end.clone().subtract(1, "days")), k = [];// inclusive day-index range for segment
            for (b = 0; b < this.rowCnt; b++)
                c = b * g, d = c + g - 1, e = Math.max(i, c), f = Math.min(j, d), e = Math.ceil(e), f = Math.floor(f), f >= e && k.push({row: b, firstRowDayIndex: e - c, lastRowDayIndex: f - c, isStart: e === i, isEnd: f === j});
            return k
        },
// Slices up a date range into a segment for every day-cell it intersects with.
// TODO: make more DRY with sliceRangeByRow somehow.
        sliceRangeByDay: function (a) {
            var b, c, d, e, f, g, h = this.daysPerRow, i = this.view.computeDayRange(a), j = this.getDateDayIndex(i.start), k = this.getDateDayIndex(i.end.clone().subtract(1, "days")), l = [];// inclusive day-index range for segment
            for (b = 0; b < this.rowCnt; b++)
...
// (colspan should be no different)
        ...
        renderBgTrHtml: function (a) {
            ...
            var c = this.view, d = this.getDayClasses(a);// if date has a time, won't format it
...
// Intro means the leftmost cell when the calendar is LTR and the rightmost cell when RTL. Vice-versa for outro.
        ...
        }}, rb = Ta.DayGrid = pb.extend(qb, {numbersVisible: !1, // should render a row for day/week numbers? set by outside view. TODO: make internal
...
// FYI: the first column is the leftmost column, regardless of date
        getCellHit: function (a, b) {
            return{row: a, col: b, component: this, // needed unfortunately :(
                left: this.colCoordCache.getLeftOffset(b), right: this.colCoordCache.getRightOffset(b), top: this.rowCoordCache.getTopOffset(a), bottom: this.rowCoordCache.getBottomOffset(a)}
...
// Renders a mock "helper" event. `sourceSeg` is the associated internal segment object. It can be null.
        renderHelper: function (b, c) {
            var d, e = [], f = this.eventToSegs(b);// assigns each seg's el and returns a subset of segs that were rendered
...
// Builds the HTML to be used for the default element for an individual segment
        fgSegHtml: function (a, b) {
            var c, d, e = this.view, f = a.event, g = e.isEventDraggable(f), h = !b && f.allDay && a.isStart && e.isEventResizableFromStart(f), i = !b && f.allDay && a.isEnd && e.isEventResizableFromEnd(f), j = this.getSegClasses(a, g, h || i), k = ca(this.getSegSkinCss(a)), l = "";
// Only display a timed events time if it is the starting segment
// we always want one line of height
// put a natural space in between
            return j.unshift("fc-day-grid-event", "fc-h-event"), a.isStart && (c = this.getEventTimeText(f), c && (l = '<span class="fc-time">' + aa(c) + "</span>")), d = '<span class="fc-title">' + (aa(f.title || "") || "&nbsp;") + "</span>", ei = (f.event_id) ? "_" + f.event_id : "", cn = (f.className) ? " " + f.className : "", pc = (f.bgcolor) ? "background: " + f.bgcolor + ";" : "", '<a id="event' + ei + '" class="' + j.join(" ") + ' ' + cn + '"' + (f.url ? ' href="' + aa(f.url) + '"' : "") + (k ? ' style="' + k + pc + '"' : ' style="' + pc + '"') + '><div class="fc-content">' + (this.isRTL ? d + " " + l : l + " " + d) + "</div>" + (h ? '<div class="fc-resizer fc-start-resizer" />' : "") + (i ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
...
// Reveals the popover that displays all events within a cell
                showSegPopover: function (a, b, c, d) {
                    ...
                    e = 1 == this.rowCnt ? h.el : this.rowEls.eq(a), f = {className: "fc-more-popover", content: this.renderSegPopoverContent(a, b, d), parentEl: this.el, top: e.offset().top, autoHide: !0, viewportConstrain: h.opt("popoverViewportConstrain"), hide: function () {
...
// Builds the inner DOM contents of the segment popover
                renderSegPopoverContent: function (b, c, d) {
                    var e, f = this.view, g = f.opt("theme"), h = this.getCellDate(b, c).format(f.opt("dayPopoverFormat")), i = a('<div class="fc-header ' + f.widgetHeaderClass + '"><span class="fc-close ' + (g ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span><span class="fc-title">' + aa(h) + '</span><div class="fc-clear"/></div><div class="fc-body ' + f.widgetContentClass + '"><div class="fc-event-container"></div></div>'), j = i.find(".fc-event-container");
...
// We mixin DayTable, even though there is only a single row of days
    var sb = Ta.TimeGrid = pb.extend(qb, {slotDuration: null, // duration of a "slot", a distinct time segment on given day, visualized by lines
        ...
        nowIndicatorEls: null, colCoordCache: null, slatCoordCache: null, constructor: function () {
...
// Relies on the view's colCnt. In the future, this component should probably be self-sufficient.
        renderDates: function () {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new lb({els: this.colEls, isHorizontal: !0}), this.slatCoordCache = new lb({els: this.slatEls, isVertical: !0}), this.renderContentSkeleton()
        },
...
// Computes a default `displayEventEnd` value if one is not expliclty defined
        ...
        prepareHits: function () {
            ...
            if (null != f && null != g) {
                ...
                return{col: f, snap: l, component: this, // needed unfortunately :(
                    left: d.getLeftOffset(f), right: d.getRightOffset(f), top: m, bottom: n}
            }
        }, getHitSpan: function (a) {
...
// Slices up the given span (unzoned start/end with other misc data) into an array of segments
        spanToSegs: function (a) {
            ...
            for (c = 0; c < this.daysPerRow; c++)
                d = this.dayDates[c].clone(), e = {start: d.clone().time(this.minTime), end: d.clone().time(this.maxTime)}, b = I(a, e), b && (b.dayIndex = c, f.push(b));
            return f
        }, /* Coordinates
         ------------------------------------------------------------------------------------------------------------------*/
...
// Renders the HTML for a single event segment's default rendering
        fgSegHtml: function (a, b) {
            var c, d, e, f = this.view, g = a.event, h = f.isEventDraggable(g), i = !b && a.isStart && f.isEventResizableFromStart(g), j = !b && a.isEnd && f.isEventResizableFromEnd(g), k = this.getSegClasses(a, h, i || j), l = ca(this.getSegSkinCss(a));// just the start time text
...
// Display the normal time text for the *event's* times
            ...
            return k.unshift("fc-time-grid-event", "fc-v-event"), f.isMultiDayEvent(g) ? (a.isStart || a.isEnd) && (c = this.getEventTimeText(a), d = this.getEventTimeText(a, "LT"), e = this.getEventTimeText(a, null, !1)) : (c = this.getEventTimeText(g), d = this.getEventTimeText(g, "LT"), e = this.getEventTimeText(g, null, !1)), ei = (g.event_id) ? "_" + g.event_id : "", cn = (g.className) ? " " + g.className : "", pc = (g.bgcolor) ? "background: " + g.bgcolor + ";" : "", '<a id="event' + ei + '" class="' + k.join(" ") + ' ' + cn + '"' + (g.url ? ' href="' + aa(g.url) + '"' : "") + (l ? ' style="' + l + pc + '"' : ' style="' + pc + '"') + '><div class="fc-content">' + (c ? '<div class="fc-time" data-start="' + aa(e) + '" data-full="' + aa(d) + '"><span>' + aa(c) + "</span></div>" : "") + (g.title ? '<div class="fc-title">' + aa(g.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (j ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        }, /* Seg Position Utils
         ------------------------------------------------------------------------------------------------------------------*/
...
// Contains important positioning-related properties that should be applied to any event element, customized or not.
        generateFgSegHorizontalCss: function (a) {
            var b, c, d = this.view.opt("slotEventOverlap"), e = a.backwardCoord, f = a.forwardCoord, g = this.generateSegVerticalCss(a);// amount of space from right edge, a fraction of the total width
...
// Subclasses can override. Must return all properties.
        computeRange: function (a) {
            var b, c, d = M(this.intervalDuration), e = a.clone().startOf(d), f = e.clone().add(this.intervalDuration);// exclusively move backwards
...
// Returns a new range object.
        computeDayRange: function (a) {
            var b, c = a.start.clone().stripTime(), d = a.end, e = null;// the beginning of the day the range exclusively ends
...
// Does the given event visually appear to occupy more than one day?
        ...
        }}), ub = Ta.Scroller = va.extend({el: null, // the guaranteed outer element
        scrollEl: null, // the element with the scrollbars
        overflowX: null, overflowY: null, constructor: function (a) {
...
// -----------------------------------------------------------------------------------------------------------------
        ...
        }}), vb = Ta.Calendar = va.extend({dirDefaults: null, // option defaults related to LTR or RTL
...
// iterate from the specific view definition to a more general one until we hit an actual View class
            for (var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a; l; )
                d = Ua[l], e = h[l], l = null, "function" == typeof d && (d = {"class": d}), d && (i.unshift(d), j.unshift(d.defaults || {}), f = f || d.duration, l = l || d.type), e && (k.unshift(e), f = f || e.duration, l = l || e.type);// valid?
...
// Given arguments to the select method in the API, returns a span (unzoned start/end and other info)
    ...
    vb.mixin(ib), vb.defaults = {titleRangeSeparator: " - ", // emphasized dash
...
// Also, sets it as the default.
    ...
    var Ab = {dataType: "json", cache: !1}, Bb = 1;
...
// LEGACY: weekMode is deprecated
    ...
    Ua.basic = {"class": Cb}, Ua.basicDay = {type: "basic", duration: {days: 1}}, Ua.basicWeek = {type: "basic", duration: {weeks: 1}}, Ua.month = {"class": Eb, duration: {months: 1}, // important for prev/next
...
// when the time-grid isn't tall enough to occupy the given height, we render an <hr> underneath
        bottomRuleEl: null, initialize: function () {
...
// Affects content-skeleton, helper-skeleton, highlight-skeleton for both the time-grid and day-grid.
        renderIntroHtml: function () {
            var a = this.view;
            return'<td class="fc-axis" ' + a.axisStyleAttr() + "></td>"
        }}, Ib = 5, Jb = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];
