        ...
        <div id="main_container" class="main_container container_16 clearfix popup">
            ...
            <div class="flat_area grid_16">
                ...
                <div class="box grid_16">
                    <div class="block">
                        <h2 class="section"><?php echo ($model->id)?"Edit":"Add";?> Controller</h2>
                        <?php 
                        if($_POST)
                        ...
                        <?php echo form_open('',array('class' => 'validate_form'));?>
                            ...
                            <fieldset class="label_side top">
                                <label for="required_field">Controller<span>Unique field</span></label>
                                <div>
                                    <input id="controller" name="controller" value="<?php echo  $model->controller ?>"  type="text" class="required"  required >
                                    <div class="required_tag"></div>
                                </div>
                            </fieldset>
                            <fieldset class="label_side top">
