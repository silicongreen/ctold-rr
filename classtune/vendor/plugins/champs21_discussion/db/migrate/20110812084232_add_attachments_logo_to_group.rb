class AddAttachmentsLogoToGroup < ActiveRecord::Migration
  def self.up
	...
	add_column :groups, :cover_file_name, :string
    add_column :groups, :cover_content_type, :string
    add_column :groups, :cover_file_size, :integer
  ...
  def self.down
	...
	remove_column :groups, :cover_file_name
    remove_column :groups, :cover_content_type
    remove_column :groups, :cover_file_size
