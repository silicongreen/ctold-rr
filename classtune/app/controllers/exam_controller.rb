    ...
    if @connect_exam_obj.result_type.to_i == 11 or @connect_exam_obj.result_type.to_i == 13 or @connect_exam_obj.result_type.to_i == 14 or @connect_exam_obj.result_type.to_i == 15 or @connect_exam_obj.result_type.to_i == 16
      ...
      unless exam_connect_merit_lists.blank?
        ...
        unless exam_connect_merit_lists.blank?
          ...
          exam_connect_merit_lists = ExamConnectMeritList.find(:all, :conditions=> "connect_exam_id = #{@connect_exam_obj.id} AND batch_id IN (#{group_batch_ids.join(",")})", :order=>"gpa1 DESC") 
          unless exam_connect_merit_lists.blank?
            i = 1
            exam_connect_merit_lists.each do |exam_connect_merit_list|
              pos = 0
  ...
  def continues
    ...
    unless exam_connect_merit_lists.blank?
      ...
      unless exam_connect_merit_lists.blank?
        ...
        exam_connect_merit_lists = ExamConnectMeritList.find(:all, :conditions=> "connect_exam_id = #{@connect_exam_obj.id} AND batch_id IN (#{group_batch_ids.join(",")})", :order=>"gpa DESC") 
        unless exam_connect_merit_lists.blank?
          i = 1
          exam_connect_merit_lists.each do |exam_connect_merit_list|
            pos = 0
    ...
    @student_position = [];
    exam_connect_merit_lists = ExamConnectMeritList.find(:all, :conditions=>"connect_exam_id = #{@connect_exam_obj.id} and batch_id = #{@batch.id} and position > 0", :order => "gpa DESC, position asc") 
    unless exam_connect_merit_lists.blank?
      exam_connect_merit_lists.each do |exam_connect_merit_list|
 ...
 Program :"+@batch.course.course_name.to_s+" || Group :"+group_name.to_s+" || Section :"+@batch.course.section_name.to_s+" || Shift :"+batch_split[0]+" || Session :"+@batch.course.session.to_s+" || Version :"+version+"
  ...
  def render_connect_exam(template,for_save=false,file_name="")
    ...
    if MultiSchool.current_school.id == 246
      ...
      if @connect_exam_obj.result_type == 1 or @connect_exam_obj.result_type == 3 or @connect_exam_obj.result_type == 5 or @connect_exam_obj.result_type == 7 or @connect_exam_obj.result_type == 9 or @connect_exam_obj.result_type.to_i == 11 or @connect_exam_obj.result_type.to_i == 12 or @connect_exam_obj.result_type.to_i == 13 or @connect_exam_obj.result_type.to_i == 14 or @connect_exam_obj.result_type.to_i == 15 or @connect_exam_obj.result_type.to_i == 16 or @connect_exam_obj.result_type.to_i == 18 or @connect_exam_obj.result_type.to_i == 19 or @connect_exam_obj.result_type.to_i == 17 or @connect_exam_obj.result_type.to_i == 22 or @connect_exam_obj.result_type.to_i == 21 or @connect_exam_obj.result_type.to_i == 23 or @connect_exam_obj.result_type.to_i == 24 or @connect_exam_obj.result_type.to_i == 25
        render :pdf => template,
