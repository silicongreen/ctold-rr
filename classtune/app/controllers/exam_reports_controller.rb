...
class ExamReportsController < ApplicationController
  ...
  filter_access_to [:archived_exam_wise_report,:list_inactivated_batches,:final_archived_report_type,:consolidated_exam_report,
      :consolidated_exam_report_pdf,:archived_batches_exam_report,:archived_batches_exam_report_pdf,:graph_for_archived_batches_exam_report], :attribute_check=>true, :load_method => lambda { current_user }
