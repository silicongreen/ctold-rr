<div id="pjax">
    <div id="wrapper" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <div id="main_container" class="main_container container_16 clearfix">
            ...
            <div class="flat_area grid_16">
                <button id="true" class="light text_only div_icon ajax" executefunction="delete_cache_header" type="button" style="float:left; margin:5px 5px 0px 0px">
                      <span>Clear Header Menu Cache</span>
                </button>
            </div> 
