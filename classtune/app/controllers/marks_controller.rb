class MarksController < ApplicationController
  ...
  def get_exams
    ...
    if data_type.to_i == 8
      ...
      @exam_connect = ExamConnect.active.find(:all,:conditions=>"batch_id="+batch_id+" and (result_type=1 or result_type=2 or result_type=5  or result_type=6  or result_type=7  or result_type=8  or result_type=10  or result_type=11  or result_type=12) and is_deleted=0")
    else
