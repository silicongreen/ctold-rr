...
/**
 * This is the model class for table "cancelled_finance_transactions".
 *
 * The followings are the available columns in table 'cancelled_finance_transactions':
 * @property integer $id
 ...
 */
class CancelledFinanceTransactions extends CActiveRecord
{
	/**
	...
	{
		return 'cancelled_finance_transactions';
	}
	...
	public function rules()
	{
		...
		return array(
			array('fine_included, category_id, student_id, finance_fees_id, master_transaction_id, finance_id, payee_id, lastvchid, user_id, batch_id, school_id', 'numerical', 'integerOnly'=>true),
			array('title, description, finance_type, payee_type, receipt_no, voucher_no, payment_mode, collection_name', 'length', 'max'=>255),
			array('amount', 'length', 'max'=>15),
			array('fine_amount', 'length', 'max'=>10),
			array('transaction_date, payment_note, created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, description, amount, fine_included, category_id, student_id, finance_fees_id, transaction_date, fine_amount, master_transaction_id, finance_id, finance_type, payee_id, payee_type, receipt_no, voucher_no, lastvchid, payment_mode, payment_note, user_id, collection_name, created_at, updated_at, batch_id, school_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CancelledFinanceTransactions the static model class
	 */
