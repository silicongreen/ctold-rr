<?php
    ...
    class Adplace
    {
        ...
        function printAds( $planId ,$menu_id = null, $b_lazy_load = true, $s_ci_key = '0' ,$location = 'index')
        {
            ...
            if($s_ci_key!='0')
            {
                $cache_name = "AD_" . $planId."_".$s_ci_key;
            }   
            else
            {
            ...
            else
            {
                ...
                {       
                    ...
                    $arAds = $obj_post->getAllAds( $planId, $location );
            ...
            if($menu_id == 0 && $s_ci_key != '0')
            {    
                $arAdsSection = $obj_post->getAllSectionAds( $planId, $s_ci_key ,$location);     
                //echo $arAdsSection->num_rows.".";
                //echo "<pre>";
                //print_r($arAdsSection);
                
            }
            else if($menu_id != null && $s_ci_key=='0')
            {
            ...
            if($count_ad_number>0)
            {
                foreach ( $arAds->result() as $row )
                {
                    ...
                    else if ( count($arMenu) > 0 && $row->plan_id == 9)
                    {
                        ...
                        {
                          $ads_menu_html = "<span class='sub-menu-news-part2 sub-menu-news-part2-last'>"."<a href='".(!empty($row->url_link)?$row->url_link:"javascript:(void);")."'>".$this->getHtml( $row, $b_lazy_load ). "</a></span>";
                    ...
                    else
                    {
                        ...
                        else if(($row->plan_id == 18 || $row->plan_id == 19 || $row->plan_id == 21) && ($row->for_all==1) && ($i <= $row->qty))
                        {
                            $ads_html .= " <a href='".(!empty($row->url_link)?$row->url_link:"javascript:(void);")."' ".(!empty($row->url_link)?"target='_blank'":"").">" . $this->getHtml( $row, $b_lazy_load ) . "</a>";
                            $i++;
                        }
                        ...
                        else if(($row->plan_id == 27 || $row->plan_id == 28 || $row->plan_id == 36 || $row->plan_id == 37  || $row->plan_id == 34 || $row->plan_id == 35) && ($row->for_all==1) && ($i <= $row->qty))
                        {
