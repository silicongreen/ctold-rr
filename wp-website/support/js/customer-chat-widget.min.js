...
function(t, e, s) {
    t.LoginFormView = Backbone.View.extend({
        ...
        initialize: function() {
            this.$name = this.$("#customer-chat-login-name"),this.$op_type = this.$("#customer-chat-login-op-type"), this.$mail = this.$("#customer-chat-login-mail"), this.$name.on("input change keydown blur", e.proxy(this.validateName, this)), this.$mail.on("input change keydown blur", e.proxy(this.validateMail, this)), this.reset()
        },
        reset: function() {
            this.$name.val(""), this.$mail.val(""), this.$op_type.val(""), this.$name.removeClass("customer-chat-input-error"), this.$mail.removeClass("customer-chat-input-error"), "true" !== s.ui.askForMail && this.$mail.hide().val("anonymous@anonymous.anonymous")
        },
...
function(t, e) {
    t.ContactFormView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.$op_type = this.$("#customer-chat-login-op-type"),
        ...
        initialize: function() {
            this.settings = t.model.settings, this.loginForm = new t.LoginFormView({
                ...
                model: s.defaultAvatars
                    ...
                    this.$opType = this.$("#customer-chat-login-op-type"),
