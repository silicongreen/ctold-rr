...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		 ...
		 *              - default true
		 */
		this.fnFilter = function( sInput, iColumn, sType, bRegex, bSmart, bShowGlobal )
		{
			var oSettings = _fnSettingsFromNode( this[_oExt.iApiIndex] );
			...
			else
			{
				...
				oSettings.aoPreSearchCols[ iColumn ].sSearch = sInput;
                                oSettings.aoPreSearchCols[ iColumn ].sType = sType;
			...
			if ( oSettings.bAjaxDataGet )
			{
				...
				if ( oSettings.oFeatures.bFilter !== false )
				{
					aoData.push( { "name": "sSearch", "value": oSettings.oPreviousSearch.sSearch } );
                                        ...
                                        aoData.push( { "name": "tds_csrf", "value": $('input[name$="tds_csrf"]').val()} );
					...
					for ( i=0 ; i<iColumns ; i++ )
					{
						aoData.push( { "name": "sSearch_"+i,     "value": oSettings.aoPreSearchCols[i].sSearch } );
                                                aoData.push( { "name": "sType_"+i,     "value": oSettings.aoPreSearchCols[i].sType } );
