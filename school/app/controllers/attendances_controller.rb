...
class AttendancesController < ApplicationController
  ...
  filter_access_to :all, :except=>[:index, :list_subject, :show, :new, :create, :edit,:update, :destroy,:subject_wise_register]
  filter_access_to [:index, :list_subject, :show, :new, :create, :edit,:update, :destroy,:subject_wise_register], :attribute_check=>true, :load_method => lambda { current_user }
