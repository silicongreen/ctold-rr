                    ...
                    <div id="myCarousel" class="carousel" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">                            
                            <div class="item active">
                                <a class="speelingbee_banner_box" title="Science Rocks" href="http://www.champs21.com/sciencerocks" target="_blank">       
                                    <img src="<?php echo base_url('styles/layouts/tdsfront/sceincerocks/img/Home_sr.png'); ?>" class="attachment-post-thumbnail wp-post-image no_toolbar" alt="Science Rocks" style="width:100%;">
                                </a> 
                            </div>
            ...
            if ($active_video_slider == true):
                ...
                <section class="slider">                    
                    ...
                    <div class="flexslider carousel" style="height:200px;margin:10px 20px;overflow: hidden;diaplay:none;">
                        <h4 class="f2" style="font-size:16px;letter-spacing:0px;margin-left:0px;color:rgb(202, 35, 42);padding: 0 0 5px;">Science Rocks Videos</h4>
                        <ul class="slides">
                            <?php if (count($news->related_news_spelling_bee) > 0): ?>
                                <?php
                ...
                <div class="video_see_more">
                    <p style="float: right;"><a href="<?php echo base_url('/videos/science-rocks'); ?>">See More</a></p>
                </div>
                <style>
                    #over
                    {
