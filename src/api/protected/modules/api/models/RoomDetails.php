 ...
 * @property integer $students_per_room
...
class RoomDetails extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('hostel_id, students_per_room, school_id', 'numerical', 'integerOnly'=>true),
			array('room_number', 'length', 'max'=>255),
			array('rent', 'length', 'max'=>15),
			array('created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, hostel_id, room_number, students_per_room, rent, created_at, updated_at, school_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('students_per_room',$this->students_per_room);
