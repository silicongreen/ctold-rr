...
module Champs21
  ...
  module Authorizations
    ...
    module Champs21PluginLoader
      
      def self.load_attribute_to_auth_rules
        plugin_auth_file_hash = {}
        Champs21Plugin::AVAILABLE_MODULES.each{|mod| plugin_auth_file_hash["#{Rails.root}/vendor/plugins/#{mod[:name]}/#{mod[:auth_file]}"]= mod[:name]}
