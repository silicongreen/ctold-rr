<div class="container"><div class="container">
	<div class="wrapper">
		...
		<div id="beforeWrap" style="background: transparent url(<?php echo base_url();?>images/cover/teacher-page.png) no-repeat bottom left;background-size:cover;">
			...
			<div class="postlist-tab2">
				<div style=" position: relative;top: 48px;z-index: 1;">
					<a href="<?php echo base_url(); ?>signup?user_type=3" style="background-color: #64b846;color: #fff;font-size: 20px;padding: 20px 40px;text-decoration: none;border-radius:5px;	-moz-border-radius:5px;	-webkit-border-radius:5px;border:1px solid #fff;box-shadow: 0 4px 2px -2px gray;">
