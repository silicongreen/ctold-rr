...
$_CONFIG = array(
    ...
    'theme' => "oxygen",
    'base_url_ci' => $s_protocol . $_SERVER['SERVER_NAME']."/",
    'base_url' => $s_protocol . $_SERVER['SERVER_NAME']."/ckeditor/kcfinder/",
    'uploadURL' => "upload",
    ...
    */),
    ...
    "thumbArray" => array(
		...
		"bigimage"=>array(698,405),
		"facebook"=>array(200,200),
		"main"=>array(130,80),
		"otherRightFirst"=>array(162,0),
		"otherSix"=>array(222,0),
