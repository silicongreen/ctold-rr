ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :subjects,:collection=>{:subgroups=>[:get],:student_excell=>[:get],:new_subgroup=>[:get],:create_group=>[:post],:edit_subgroup=>[:get],:update_group=>[:post],:delete_subgroup=>[:post,:delete],:grading_level=>[:get],:new_grading_level=>[:get],:create_grading_level=>[:post],:edit_grading_level=>[:get],:update_grading_level=>[:post],:delete_grading_level=>[:post,:delete]}
 
  map.resources :attendances, :collection=>{:class_open=>:get,:add_class_open=>[:get,:post],:remove_class_open=>:get,:rollcall=>:get,:get_att_log=>:get,:subjects=>:get,:get_subject_student=>:get,:save_attendance_subject=>:post,:graph_code=>:get,:daily_register=>:get,:subject_wise_register=>:get,:get_subject_report_pdf=>:get,:get_subject_batch_report_pdf=>:get,:get_subject_batch_report_excel=>:get}
