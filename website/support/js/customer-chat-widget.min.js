        ...
        e.setup({
            ...
            onready: function() {
                if (i.play = function(t) {
                    ...
                    for (var o = 0; o < t.length; o++) i.addSounds(t[o])
            }
        })
    }
...
function(t, e, s, i) {
    var o = t.GuestChatModel = Backbone.Model.extend({
        ...
        lastTypingUpdate: 0,
        initialize: function() {
            this.on("login:success", this.manageConnection, this), this.on("messages:new", this.storeMessages, this), this.on("messages:new", this.confirmMessagesRead, this)
        },
        autoLogin: function() {
            var t = this;
            e.post(s.isLoggedInPath, {
                ...
                i.success ? (t.set({
                    ...
                    mail: i.mail,
                    image: i.image
                }), t.trigger("login:success"), e.get(s.lastMessagesPath, function(e) {
        ...
        login: function(t) {
            var i = this;
            t.info = JSON.stringify(s.info), e.post(s.loginPath, t, function(e) {
                e.success ? (i.set({
                    name: t.name,
                    mail: t.mail,
                    image: t.image
                }), i.trigger("login:success")) : i.trigger("login:error")
            })
        },
        logout: function() {
            ...
            this.sendMessage(new t.MessageModel({
                ...
                e.post(s.logoutPath, function(t) {
                    t && t.success ? i.trigger("logout:success") : i.trigger("logout:error")
                })
            }), this.lastMessages = [], this.trigger("logout:init")
        },
        checkOperators: function(t) {
            var i = this,
                o = e.get(s.isOperatorOnlinePath, function(t) {
                    t.success ? i.trigger("operators:online") : i.trigger("operators:offline")
                });
            t && o.always(t)
        },
        ...
        updateTypingStatus: function() {
            ...
            if (t) {
                ...
                this.lastTypingUpdate + o.POLLING_INTERVAL < i && (this.lastTypingUpdate = i, e.post(s.updateTypingStatusPath, {
                    secondUserId: t,
                    status: !0
                }))
            }
        ...
        getTypingStatus: function(t) {
            var i = this.lastOperator && this.lastOperator.id;
            if (i) {
                var o = this,
                    n = e.post(s.getTypingStatusPath, {
                        ids: [i]
                    }, function(t) {
                        t.success && t.results[i] && o.trigger("operator:typing")
                    });
                t && n.always(t)
            } else t && t()
        },
        getMessages: function(t) {
            var i = this,
                o = e.get(s.newMessagesPath, function(t) {
                    t.length > 0 && i.loadOperatorsData(t, function() {
                        t.authorType = "operator", i.trigger("messages:new", t)
                    })
                });
            t && o.always(t)
        },
        confirmMessagesRead: function(t) {
            ...
            e.post(s.markMessagesReadPath, t)
        },
        ...
        loadOperatorsData: function(t, i) {
            for (var o = this, n = 0, a = 0; a < t.length; a++) {
                var h = t[a];
                this.operatorsCache[h.from_id] || (n++, e.post(s.getOperatorPath, {
                    id: h.from_id
                }).success(function(t) {
        ...
        sendMessage: function(t, i) {
            var o = {
                    body: t.get("body")
                },
                n = this;
            e.post(s.sendMessagePath, o, function(t) {
                t.success ? n.trigger("messages:sent") : n.trigger("messages:sendError"), i && i(t)
            }), this.storeMessages([t.attributes])
        },
        manageConnection: function() {
            this.stopConnectionManagement(), this.initRequestsStatus(), this.connectionTimer = setInterval(e.proxy(this._manageConnection, this), o.POLLING_INTERVAL), this._manageConnection()
        },
        _manageConnection: function() {
            if (this.prevRequestsComplete()) {
                ...
                this.getMessages(function() {
                    t.requestsStatus.getMessages = !0
                }), this.keepAlive(function() {
                    t.requestsStatus.keepAlive = !0
                }), this.getTypingStatus(function() {
                    t.requestsStatus.getTypingStatus = !0
                }), this.checkOperators(function() {
                    t.requestsStatus.checkOperators = !0
                })
            }
        },
        prevRequestsComplete: function() {
            if (Date.now() - this.requestInitTime > o.REQUEST_STATUS_RESET_TIMEOUT) return this.initRequestsStatus(), !0;
...
function(t, e, s) {
    t.LoginFormView = Backbone.View.extend({
        ...
        reset: function() {
            this.$name.val(""), this.$mail.val(""), this.$name.removeClass("customer-chat-input-error"), this.$mail.removeClass("customer-chat-input-error"), "true" !== s.ui.askForMail && this.$mail.hide().val("anonymous@anonymous.anonymous")
        },
...
function(t, e) {
    t.ContactFormView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.$contactSchool.on("input change keydown blur",e.proxy(this.schoolValid, this)),
            this.$contactStartTime.on("input change keydown blur",e.proxy(this.startValid, this)),
            this.$contactEndTime.on("input change keydown blur",e.proxy(this.endValid, this))
        },
        reset: function() {
            this.$name.val(""), 
            this.$mail.val(""), 
        ...
        {
            if(this.$contactEndTime.val().length == 0 || !this.timeExp.test(this.$contactEndTime.val()) || this.$contactEndTime.val()<=this.$contactStartTime.val())
            {
        ...
        isValid: function() {
            return this.validateName(), this.validateMail(),this.validateSchool(),this.validateStart(),this.validateEnd(), this.validateMessage(), this.nameValid && this.mailValid && this.messageValid && this.schoolValid && this.startValid && this.endValid
        }
    })
}(window.Application, jQuery),
function(t, e, s) {
    var i = /(\w+:\/\/)?([\da-z\.\-@]+)\.([a-z\.]{2,})([?&=%#;\/\w\.-]*)*\/?/g,
        o = t.MessageView = Backbone.View.extend({
            ...
            updateTime: function(t) {
                ...
                var g = a > 0 ? l : n > 0 ? n + " " + e.ui.timeDaysAgo : o > 0 ? o + " " + e.ui.timeHoursAgo : i > 0 ? i + " " + e.ui.timeMinutesAgo : Math.max(s - s % 5, 1) + " " + e.ui.timeSecondsAgo;
                if (this.$time.html(g), t) {
                    var u = n > 0 ? -1 : o > 0 ? 60 * (60 - i % 60) * 60 : i > 5 ? 60 * (5 - i % 5) : i > 0 ? 60 : 10 - s % 10;
                    if (-1 == u) return;
                    var m = this;
...
function(t, e, s) {
    var i = t.WidgetView = Backbone.View.extend({
        events: {
        ...
        setState: function(e) {
            if (this.state != e) switch (this.state = e, this.$settings.hide(), this.$emoticons.hide(), this.$el.removeClass("login-form chat-box contact-form loading-screen info-screen"), e) {
                case "loading":
                    this.$el.addClass("loading-screen"), this.$title.html(s.ui.loadingLabel);
                    break;
                case "chat":
                    this.$el.addClass("chat-box"), this.$title.html(s.ui.chatHeader);
                    for (var i = 0; i < this.model.lastMessages.length; i++) {
                        var o = this.model.lastMessages[i],
                    ...
                    break;
                case "login":
                    this.$el.addClass("login-form"), this.$title.html(s.ui.chatHeader), this.fullscreenOff(), this.prevState = e;
                    break;
                case "contact":
                    this.$el.addClass("contact-form"), this.$title.html(s.ui.contactHeader), this.fullscreenOff(), this.prevState = e;
                    break;
                case "info":
        ...
        toggle: function(t) {
            s.mobile || t && t.target !== t.currentTarget || (this.visible ? this.hide() : this.show())
        },
        ...
        toggleSetting: function(t) {
            var s = e(t.currentTarget),
                i = s.attr("id").split("customer-chat-setting-toggle-")[1];
            this.settings.set(i, !this.settings.get(i))
        },
        endChat: function() {
        ...
        addEmoticon: function(t) {
            ...
            this.$input.val(this.$input.val() + " " + i.data("emot") + " "), s.mobile || this.$input.focus(), this.$emoticons.fadeOut("fast")
        },
        handleMessages: function(s) {
        ...
        _sendMessage: function(e) {
            if (0 != e.length) {
                ...
                this.model.sendMessage(s), this.chatBox.addMessage(s, !0)
            }
        },
        inputFocus: function() {
        ...
        handleOperatorTyping: function() {
            this.startTypingInfoBlink(), this.stopTypingBlinkTimer && clearTimeout(this.stopTypingBlinkTimer), this.stopTypingBlinkTimer = setTimeout(e.proxy(this.stopTypingInfoBlink, this), i.TYPING_STATUS_TIME)
        },
        sendContactMessage: function() {
            var t = {
                ...
                userInfo: JSON.stringify(s.info)
            };
            if (this.contactForm.isValid()) {
                var i = this;
                e.post(s.contactPath, t, function(t) {
                    t.success ? (i.contactForm.reset(), i.showInfo(s.ui.contactSuccessMessage, s.ui.contactSuccessHeader)) : i.showInfo(s.ui.contactErrorMessage, s.ui.contactErrorHeader)
                }), this.showLoading()
            }
        },
        ...
        showWelcomeMessage: function() {
            var e = new t.MessageModel({
                authorType: "operator",
                author: s.ui.initMessageAuthor,
                body: s.ui.initMessageBody,
                time: new Date
            });
            this.chatBox.addMessage(e)
        },
        showChat: function() {
            this.setState("chat"), this.manualLogin && s.mobile && window.location.reload()
        },
        ...
        storeProperties: function(t) {
            if (!s.mobile && !this.fullscreen) {
                this.headerHeight = this.$header.height();
                var e = this;
                this.postMessage("get.properties", function(s) {
                    var i = s.split(",");
                    e.frameWidth = parseInt(i[0]), e.frameHeight = parseInt(i[1]), e.frameOffset = parseInt(i[2]), t && t()
                })
            }
        },
        postMessage: function(t, e) {
            if (!s.mobile && (window.parent.postMessage(t, "*"), e)) {
                var i = this.$window,
                    o = Math.floor((new Date).getTime() * Math.random());
                this.$window.bind("message." + o, function(s) {
                    var n = s.originalEvent.data.split(":");
                    n[0] === t && e(n[1]), i.unbind("message." + o)
                })
            }
        },
...
function(t, e) {
    ...
    t.get(e.templatesPath, function(e) {
        ...
        i.service.soundPlayer = new i.SoundPlayer, i.template.message = s.find("#message").html(), i.model.settings = new i.GuestSettingsModel, i.model.chat = new i.GuestChatModel, i.view.widget = new i.WidgetView({
            el: "#customer-chat-widget",
            model: i.model.chat
        }), window.phpLiveChat = new i.WidgetFacade, new i.PostMessageApiAdapter(window.phpLiveChat)
    })
});