...
class FinanceController < ApplicationController
  ...
  def transaction_pdf_fees_csv
    ...
    elsif (@filter_by_course.to_i == 1 and @filter_by_payment_type.to_i == 0) or (@filter_by_course.to_i == 1 and @filter_by_payment_type.to_i == 1) or (@filter_by_course.to_i == 1 and @filter_by_payment_type.to_i == 2) 
      fees_month = {}
      fees_month_diff = {
        "0307" => "-4745.00",
        "0311" => "8055.00",
