...
class FeeTransactions extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('finance_fee_id, finance_transaction_id, school_id', 'numerical', 'integerOnly'=>true),
			array('created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, finance_fee_id, finance_transaction_id, created_at, updated_at, school_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    'transaction' => array(self::BELONGS_TO, 'FinanceTransactions', 'finance_transaction_id',
                                'joinType' => 'INNER JOIN',
                    ),
		);
	}
