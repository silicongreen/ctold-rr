 ...
 */
class Spelltvhighscore extends CActiveRecord
{
    ...
    public function getUserRank( $score_for_rank,$time_for_rank )
    {
        if($score_for_rank==0)
        {
            return 0;
