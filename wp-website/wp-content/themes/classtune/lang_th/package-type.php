                    ...
                    <div class="row package-box <?php if ($act == "premium"): ?>hide<?php endif; ?>" id="basic-box" style="background-color:#FFF;">
                        ...
                        <div class="col-md-12"  style="">                                    
                            <div class="row" style="text-align: left;border-bottom:1px solid #ccc;">                                           
                                <div class="col-md-4 border_right"  style="width:26%;height: 232px;">                                                
                                    <img src="<?php bloginfo('template_url'); ?>/images/package-2.png" style="left: 50%;margin-left: -100px;margin-top: -50px;position: absolute;top: 50%;">
                                </div>
                            ...
                            <div class="row" style="text-align: left;border-bottom:1px solid #ccc;">                                           
                                <div class="col-md-4 border_right"  style="width:26%;height: 150px;">
                                    <img src="<?php bloginfo('template_url'); ?>/images/package-3.png" style="left: 50%;margin-left: -100px;margin-top: -60px;position: absolute;top: 50%;">
                                </div>
                                <div class="col-md-4" id="basic_log" style="width:32%;padding: 20px;height: 150px;">
                                    <img src="<?php bloginfo('template_url'); ?>/images/close.png" style="left: 50%;margin-left: -60px;margin-top: -50px;position: absolute;top: 50%;">
                                </div>
                            ...
                            <div class="row" style="text-align: left;border-bottom:1px solid #ccc;">                                           
                                <div class="col-md-4 border_right"  style="width:26%;height: 165px;">
                                    <img src="<?php bloginfo('template_url'); ?>/images/package-4.png" style="left: 50%;margin-left: -100px;margin-top: -60px;position: absolute;top: 50%;">
                                </div>
                            ...
                            <div class="row" style="text-align: left;border-bottom:1px solid #ccc;">                                           
                                <div class="col-md-4 border_right"  style="width:26%;height: 145px;">
                                    <img src="<?php bloginfo('template_url'); ?>/images/package-1.png" style="left: 50%;margin-left: -100px;margin-top: -50px;position: absolute;top: 50%;">
                                </div>
                        ...
                        <div class="col-md-12" style="padding:0px;border-bottom:1px solid #ccc;">
                            ...
                            <div class="col-md-4 pack_log" id="basic_log" style="width:32%;height: 90px;background:#E9E7E8;text-align: center;padding:20px;cursor:pointer;">
                                ...
                                <a href="<?php echo get_site_url().'/'.$lang; ?>/admin-signup<?php echo "-".$lang;?>?local=basic" class="btn btn-info btn-basic">
                                    Get Started Now</a>
                            </div>
                            <div class="col-md-4 pack_log border_left" id="premium_log" style="width:42%;height: 90px;background:#E9E7E8;text-align: center;padding:20px;cursor:pointer;">
                                ...
                                <a href="<?php echo get_site_url().'/'.$lang; ?>/admin-signup<?php echo "-".$lang;?>?local=premium" class="btn btn-danger btn-basic">
                                    Get Started Now</a>	
                            </div>
                        </div>
                    </div>
