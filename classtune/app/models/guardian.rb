...
class Guardian < ActiveRecord::Base
  ...
  def archive_guardian(archived_student,id)
    ...
    if d=ArchivedGuardian.create(guardian_attributes)
      ...
      if student.all_siblings.empty? and !student.all_siblings.empty?
  ...
  def create_guardian_user(student,is_deleted=false)
    user = User.new do |u|
      ...
      # if MultiSchool.current_school.code == "oids" or MultiSchool.current_school.code == "mevsc" or MultiSchool.current_school.code == "cbis"
  ...
  def current_ward_id
    ...
    if checked
      ...
      batch_students= GuardianStudents.find_all_by_guardian_id(self.id)
      if !batch_students.nil? and !batch_students.first.nil?
