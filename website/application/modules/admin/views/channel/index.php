        ...
        <div id="main_container" class="main_container container_16 clearfix">
            ...
            <?php echo form_open('',array('class' => 'validate_form'));?>
                ...
                <div class="box grid_16" >
                    ...
                    $filter_array[1] = array("Status", "form_dropdown", $status);
                    
                    create_filter($filter_array);
                    ?>
                </div>
            
                <?php if(access_check("channel", "add")):?>
                    <div class="flat_area grid_16">
                        <button  type="button"  class="light text_only has_text model" id="<?php echo base_url();?>admin/channel/add/" >
