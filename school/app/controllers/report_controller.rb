class ReportController < ApplicationController
  ...
  def batch_fee_collections
    ...
    if Champs21Plugin.can_access_plugin?("champs21_transport") and Champs21Plugin.can_access_plugin?("champs21_hostel")
    ...
    elsif Champs21Plugin.can_access_plugin?("champs21_hostel")
    ...
    elsif Champs21Plugin.can_access_plugin?("champs21_transport")
  ...
  def student_wise_fee_collections
    ...
    if Champs21Plugin.can_access_plugin?("champs21_hostel") and Champs21Plugin.can_access_plugin?("champs21_transport")
