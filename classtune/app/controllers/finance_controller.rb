...
#        end
        ...
        @particular_wise_transactions.each do |p|
          p_amount += p.amount.to_f
        end
        @transactions_advances.each do |p|
          a_amount += p.amount.to_f
        end
        @transactions_discount.each do |p|
          d_amount += p.amount.to_f
        end
        abort(p_amount.to_s + "  " + a_amount.to_s + "  " + d_amount.to_s)
