...
class UserController < ApplicationController
  ...
  before_filter :login_required, :except => [:new_student_registration,:new_guardian, :forgot_password, :login, :set_new_password, :reset_password]
...
def new_student_registration   
  ...
  if request.post?
    ...
    if params[:activation_code]==""
      ...
      if @activation_code.nil?
        @activation_code_no_error = false
        @student.errors.add("Invalid", "Activation Code")
      end
    end  
