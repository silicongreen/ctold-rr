        ...
        <div class="col-md-3 social-bar">
            ...
            <div class="col-lg-6 social_box">
                ...
                <div  style="margin-top:10px; width:auto; cursor: pointer; float:right; clear: both;" id="share_<?php echo $post_id; ?>" class="share_class" style="cursor: pointer;">                    
                    <div class="seen">
                        <a class="addthis_button_compact" id="addthis_<?php echo $post_id; ?>" <?php if(can_sharepost($post_id)==1): ?> style="display:none;" <?php endif; ?> addthis:url="<?php echo create_link_url(NULL, urlencode($headline),$post_id); ?>" addthis:title="<?php echo $headline; ?>" id="full_leader_board">
