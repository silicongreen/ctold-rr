...
class BlogComments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('is_deleted, user_id, blog_post_id, school_id', 'numerical', 'integerOnly'=>true),
			array('body, created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, body, is_deleted, user_id, blog_post_id, created_at, updated_at, school_id', 'safe', 'on'=>'search'),
		);
	}
