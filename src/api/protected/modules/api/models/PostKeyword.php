...
/**
 * This is the model class for table "tds_post_keyword".
 *
 * The followings are the available columns in table 'tds_post_keyword':
 * @property integer $id
 * @property integer $post_id
 * @property integer $keyword_id
 */
class PostKeyword extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('post_id, keyword_id', 'required'),
            array('post_id, keyword_id', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, post_id, keyword_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'keywords' => array(self::BELONGS_TO, 'Keywords', 'keyword_id'),
        );
    }
     ...
     * @return PostKeyword the static model class
     */
    ...
    public function getPostTotal($id, $user_type)
    {
        ...
        $criteria->compare("keywords.id", $id);
