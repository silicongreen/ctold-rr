                    ...
                    if rs['exam_category'] == '1'
                      ...
                      if rs['quarter'] == '1'
                        ...
                        if !rs['result'][rs['exam_id']][sub['id']][std['id']]['grade'].blank? && rs['result'][rs['exam_id']][sub['id']][std['id']]['grade'] == "F" && fourth_subject.blank? && (rs['result'][rs['exam_id']][sub['id']][std['id']]['marks_obtained'].to_i != 8 or rs['result'][rs['exam_id']][sub['id']][std['id']]['full_mark'].to_i != 25)
                          unless sub['subject_group_id'].to_i > 0 or @connect_exam_obj.result_type == 3 or @connect_exam_obj.result_type == 4
                            u_grade1 = u_grade1+1
                            subject_failed = true
                          end
                        end  
                      ...
                      if rs['quarter'] == '1'
                        ...
                        if !rs['result'][rs['exam_id']][sub['id']][std['id']]['grade'].blank? && rs['result'][rs['exam_id']][sub['id']][std['id']]['grade'] == "F" && fourth_subject.blank? && (rs['result'][rs['exam_id']][sub['id']][std['id']]['marks_obtained'].to_i != 8 or rs['result'][rs['exam_id']][sub['id']][std['id']]['full_mark'].to_i != 25)
                          if sub['subject_group_id'].to_i == 0 || sub['code'].to_s == "Ban-1" && (@connect_exam_obj.result_type != 3 or @connect_exam_obj.result_type != 4)
                            u_grade1 = u_grade1+1
                            subject_failed = true
                          end
                        end 
