    ...
    <div id="assessment-popup-wrapper">
        ...
        <div class="assessment-popup-body">
            ...
            <div class="assessment-popup-btn-wrapper">
                <a class="red" id="start_assessment_now" href="<?php echo base_url(); ?>front/ajax/sharepost/<?php echo $post_id; ?>" >
                    <span class="clearfix f2">
                       School
                    </span>
                </a>
                
                <a class="addthis_button_compact red" addthis:url="<?php echo create_link_url(NULL, $post->headline,$post_id,false,true,false); ?>" addthis:title="<?php echo $post->headline; ?>" id="full_leader_board">
                    <span class="clearfix f2">
                        Share
                    </span>
                </a> 
...
addthis.addEventListener('addthis.user.clickback', addthisReady);
</script>
<style>
    .cann_play{
    color: #DC3131;
