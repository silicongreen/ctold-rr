class Api::SubjectsController < ApiController
  ...
  def index
    ...
    respond_to do |format|
      unless params[:search].present? and (params[:search][:batch_name_equals].present? or params[:search][:batch_name_eq].present?) and (params[:search][:batch_course_code_equals].present? or params[:search][:batch_course_code_eq].present?)
