...
/**
 * This is the model class for table "tds_post_gallery".
 *
 * The followings are the available columns in table 'tds_post_gallery':
 * @property integer $id
 ...
 * @property Post $post
 */
class PostGallery extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, post_id, material_id, caption, source', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PostGallery the static model class
	 */
