 ...
 */
/*
  Template Name: school-admin-signup
 */
get_header();
...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main" style="margin-top: 120px;">
        <iframe id="iframe_change_height" src="http://www.classtune.com/createschool/userregister/<?php echo $school_type; ?>?headless=1" style="border:1px solid white" style="border:0;" width="100%" scrolling="no"></iframe>
        <style>
