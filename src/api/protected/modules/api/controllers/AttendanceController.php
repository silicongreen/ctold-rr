...
class AttendanceController extends Controller
{
    ...
    public function actionReport()
    {
        ...
        //print_r($user_secret);
        //&& (Yii::app()->user->isTeacher || Yii::app()->user->isAdmin)
        echo Yii::app()->user->user_secret === $user_secret . 'attrn ';
        echo Yii::app()->user->isStudent . 'attrn';
        if (Yii::app()->user->user_secret === $user_secret && ( Yii::app()->user->isStudent || (Yii::app()->user->isParent && $student_id )))
        { 
            if (Yii::app()->user->isStudent)
            {
            ...
            if ($total > 0)
            {
                ...
                $fullname = ($stdData['first_name']) ? $stdData['first_name'] . " " : "";
                ...
                if(isset($late[$stdData['id']]))
                {
                    $std_data['late'] = (int)$late[$stdData['id']];
        ...
        foreach ($all_students as $key => $value)
        {
            ...
            if($value->school_id == 352)
            {
                ...
                else 
                {
                    ...
                    $message = "সম্মানিত অভিভাবক, আসসালামু আলাইকুম, আপনার সন্তান আজ শ্রেণি কার্যক্রমে অনুপস্থিত ছিল। আপনাকে শ্রেণি শিক্ষকের সাথে যোগাযোগ করার জন্য অনুরোধ করা হল । অধ্যক্ষ-এসএজিসি";
                }
            }
            if($value->school_id != 352)
            {
