...
Date.months_small = $w("Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec" );
...
CalendarDateSelect.prototype = {
  ...
  initHeaderDiv: function() {
    ...
    this.close_button = header_div.build("a", { innerHTML: "x", href:"javascript:;", onclick:function () { this.close(); return false; }.bindAsEventListener(this), className: "close" });
    this.next_month_button = header_div.build("a", { innerHTML: "&gt;", href:"javascript:;", onclick:function () { this.navMonth(this.date.getMonth() + 1 ); return false; }.bindAsEventListener(this), className: "next" });
    this.prev_month_button = header_div.build("a", { innerHTML: "&lt;", href:"javascript:;", onclick:function () { this.navMonth(this.date.getMonth() - 1 ); return false; }.bindAsEventListener(this), className: "prev" });
