...
require APPPATH . "libraries/kcfinder/core/autoload.php";
...
$file = APPPATH . "libraries/kcfinder/lang/" . $input->get['lng'] . ".php";
$files = dir::content(APPPATH . "libraries/kcfinder/lang", array(
    'types' => "file",
    'pattern' => '/^.*\.php$/'
));
