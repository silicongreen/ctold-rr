...
class AttendanceReportsController < ApplicationController
  ...
  filter_access_to :all, :except=>[:index, :subject, :mode, :show, :year, :report, :filter, :student_details,:report_pdf,:filter_report_pdf]
  filter_access_to [:index, :subject, :mode, :show, :year, :report, :filter, :student_details,:report_pdf,:filter_report_pdf], :attribute_check=>true, :load_method => lambda { current_user }
