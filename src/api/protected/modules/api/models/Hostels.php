...
class Hostels extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, hostel_type, other_info', 'length', 'max'=>255),
			array('created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, hostel_type, other_info, employee_id, created_at, updated_at, school_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('hostel_type',$this->hostel_type,true);
