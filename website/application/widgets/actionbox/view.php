...
<div class="action-box" style="background:#F7F7F7">
    <div class="col-lg-3" style="border-right:1px solid #DADEDF; min-height: 39px;">
            <div style="width:<?php echo $seen_class['width']; ?>px; margin: 0 auto;">
                <div class="seen-image col-lg-<?php echo $seen_class['class1']; ?>" style="text-align:right;margin-top:12px;" ><img  class="no_toolbar"  src="<?php echo base_url("styles/layouts/tdsfront/images/social/seen.png"); ?>" /></div>
