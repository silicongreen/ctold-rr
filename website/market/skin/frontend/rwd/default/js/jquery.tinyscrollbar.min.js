(function(a) {
    ...
    function b(q, g) {
        var k = this, t = q, j = {obj: a(".viewport", q)}, h = {obj: a(".overview", q)}, d = {obj: a(".scrollbar", q)}, m = {obj: a(".track", d.obj)}, p = {obj: a(".thumb", d.obj)}, l = g.axis === "x", n = l ? "left" : "top", v = l ? "Width" : "Height", r = 0, y = {start: 0, now: 0}, o = {}, e = "onmouseover" in document.documentElement;
        function c() {
            k.update();
            s();
            return k
        ...
        function s() {
            if (!e) {
                ...
                j.obj[0].onmouseover = function(z) {
