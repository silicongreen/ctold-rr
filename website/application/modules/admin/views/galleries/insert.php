<script src="<?= base_url() ?>scripts/custom/customGalleries.js"></script>
<div id="pjax">
                    ...
                    <div class="block">
                        ...
                        <?php echo form_open('',array('class' => 'validate_form'));?>
                            ...
                            <fieldset class="label_side top">
                                <label for="required_field">Gallery<span>Unique field</span></label>
                                <div>
                            ...
                            <fieldset class="label_side top">
                                <label for="required_field">Gallery For</label>
                                <div>
                                    <?php
                                    $a_gallery_for = array('1'=>'Spelling Bee','2'=>'Others');
                                    
                                    if(!$model->gallery_for)
                                        $model->gallery_for = 0;
                                    echo form_dropdown('gallery_for', $a_gallery_for,$model->gallery_for);
                                    ?>
                                    <div class="required_tag"></div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="label_side top">
                                <label for="required_field">Gallery Image</label>
                                <div>
