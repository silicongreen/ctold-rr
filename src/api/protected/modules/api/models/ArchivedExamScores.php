...
/**
 * This is the model class for table "archived_exam_scores".
 *
 * The followings are the available columns in table 'archived_exam_scores':
 * @property integer $id
 ...
 */
class ArchivedExamScores extends CActiveRecord
{
	/**
	 ...
	 * @return ArchivedExamScores the static model class
	 */
