                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td valign="middle" width="100%" align="center" style="border-collapse:collapse;padding:10px 0">
                                                                <div>
                                                                    <a href="<?php echo Settings::$classtune_domain_name; ?>" target="_blank">
                                                                        <img src="<?php echo Settings::$classtune_domain_name . 'images/classtune_email_logo.png'; ?>" alt="Classtune" width="225" border="0" style="display:block;outline:none;text-decoration:none;border:none">
                                                                    </a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" style="vertical-align:top;font-family:Helvetica,arial,sans-serif;font-size:14.5px;color:#666666;text-align:left;line-height:20px;border-collapse:collapse" align="left">
                                                                                                <span>Dear <?php echo $user_data->first_name . ' ' . $user_data->last_name . ','; ?></span><br /><br />
                                                                                                <span>We got a request to request your Classtune password.</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr>                                                                                    
                                                                                            <td valign="top" style="vertical-align:top;font-family:Helvetica,arial,sans-serif;font-size:15px;color:#666666;text-align:left;line-height:20px;border-collapse:collapse" align="left">
                                                                                                <p style="line-height:40px; margin-top: 20px;">
                                                                                                    <span>To reset your current password please <a style="color: #2CABE1;" href="<?php echo $reset_password_url; ?>">click here</a> or 
                                                                                                        go to the following url:</span>
                                                                                                </p>

                                                                                                <a style="color: #2CABE1;" href="<?php echo $reset_password_url; ?>"><?php echo $reset_password_url; ?></a>
                                                                                        ...
                                                                                        <tr>  
                                                                                            <td valign="top" style="vertical-align:top;font-family:Helvetica,arial,sans-serif;font-size:15px;color:#666666;text-align:left;line-height:20px;border-collapse:collapse" align="left">
                                                                                                <p style="line-height:40px; margin-top: 20px;">
                                                                                                    <span>
                                                                                                        If you didn't make this request ignore this message and your password won't be changed.
                                                                                                    </span>
                                                                                                </p>
                                                                                            </td>
                                                                                        </tr>
