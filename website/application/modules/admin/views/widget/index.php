<div id="pjax">
    <div id="wrapper" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <input type="hidden" id="modelheight" value="100%" >
        ...
        <div id="main_container" class="main_container container_16 clearfix">
            ...
            <?php if(access_check("widget_manager","add")): ?>
            <div class="flat_area grid_16">
                <button  type="button"  class="light text_only has_text model" id="<?php echo  base_url(); ?>admin/widget_manager/add/" >
