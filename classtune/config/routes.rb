ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :attendances, :collection=>{:class_open=>:get,:add_class_open=>[:get,:post],:remove_class_open=>:get,:rollcall=>:get,:get_att_log=>:get,:subjects=>:get,:get_subject_student=>:get,:save_attendance_subject=>:post,:graph_code=>:get,:daily_register=>:get,:subject_wise_register=>:get,:get_subject_report_pdf=>:get}
