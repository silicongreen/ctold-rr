    ...
    $(function() {
        ...
        $( ".portlet-header .ui-icon" ).click(function() 
        {
            ...
            else
            {
                ...
                $.post('<?php echo base_url();?>admin/sccategories/sub_categories', {category_id: id,tds_csrf: $('input[name$="tds_csrf"]').val()}, function(data){
        ...
        $("#arrange_category").on("click", function(){
            ...
            $.post('<?php echo base_url();?>admin/sccategories/save_priorities', {category_ids: category_ids,tds_csrf: $('input[name$="tds_csrf"]').val()}, function(data){
...
<div class="display_none">						
    <div id="dialog_category_arrange" class="dialog_content narrow" title="Arrange">
        <div class="block">
            <div class="section">
                <h1>Topic Arrangement</h1>
                <div class="dashed_line"></div>	
                <p>Topic has been Successfully Arranged </p>
                <p>Press The Ok button for continue</p>
            </div>
            <div class="button_bar clearfix">
                <button id="btn_close" class="dark blue no_margin_bottom link_button" data-link="<?php echo  base_url() ?>admin/sccategories/sort_categories/">
