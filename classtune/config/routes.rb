ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :attendances, :collection=>{:rollcall=>:get,:subjects=>:get,:get_subject_student=>:get,:save_attendance_subject=>:post,:graph_code=>:get,:daily_register=>:get,:subject_wise_register=>:get}
