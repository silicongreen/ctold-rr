class AddNewColumnsForAcl < ActiveRecord::Migration
  def self.up
    ...
    add_column :students,  :student_activation_code, :string, :default => false
    
    add_column :students,  :class_teacher_id, :integer, :default => 0
    
    add_column :events,  :event_category_id, :integer, :default => false
    
    add_column :events,  :fees, :integer, :default => 0.00
    
    add_column :events,  :icon_number, :integer, :default => false
    
    add_column :events,  :is_club, :integer, :default => 0
    
    add_column :subjects,  :icon_number, :integer, :default => false
