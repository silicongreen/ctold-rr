        ...
        <div id="main_container" class="main_container container_16 clearfix popup">
            ...
            <div class="flat_area grid_16">
                ...
                <div class="box grid_16">
                    <div class="block">
                        <h2 class="section"><?php echo ($model->id)?"Edit":"Add";?> School Activity</h2>
                    ...
                    <fieldset class="label_side top">
                        ...
                        <fieldset class="label_side top">
                            ...
                            <div id="publish_date_div" >
                                <input  type="text" name="date" value="<?= $model->date ?>" id="date" class="datetimepicker_class required" required    >
                                <div class="required_tag"></div>
                            </div>
