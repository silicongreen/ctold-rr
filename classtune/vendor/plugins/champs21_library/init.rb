...
#under the License.
require 'translator'
require File.join(File.dirname(__FILE__), "lib", "champs21_library")
require 'acts_as_taggable'

Champs21Plugin.register = {
  :name=>"champs21_library",
  :description=>"Champs21 Library Module",
  :auth_file=>"config/library_auth.rb",
  :more_menu=>{:title=>"library_text",:controller=>"library",:action=>"index",:target_id=>"more-parent"},
  :sub_menus=>[{:title=>"manage_books",:controller=>"books",:action=>"index",:target_id=>"champs21_library"},
    {:title=>"search_book_text",:controller=>"library",:action=>"search_book",:target_id=>"champs21_library"},
    {:title=>"return_book",:controller=>"book_movement",:action=>"return_book",:target_id=>"champs21_library"},
    {:title=>"issue_books",:controller=>"book_movement",:action=>"direct_issue_book",:target_id=>"champs21_library"},
    {:title=>"library_setting_text",:controller=>"library",:action=>"card_setting",:target_id=>"champs21_library"},
    {:title=>"movement_log_index",:controller=>"library",:action=>"movement_log",:target_id=>"champs21_library"},
    {:title=>"book_renewal",:controller=>"book_movement",:action=>"renewal",:target_id=>"champs21_library"},
    {:title=>"manage_book_additional_details",:controller=>"books",:action=>"add_additional_details",:target_id=>"champs21_library"}],
...
Champs21Library.attach_overrides
