...
class ExamController < ApplicationController
  ...
  def tabulation_excell
    ...
    if !@student_position.blank? && @student_position_first_term_batch.blank?
      @subject_highest_1st_term = @subject_highest
      @student_position_first_term = @student_position
      @student_position_first_term_batch = @student_position_batch
    elsif !@student_position_second_term.blank? && @student_position_first_term_batch.blank?
 ...
 Program :"+@batch.course.course_name.to_s+" || Group :"+group_name.to_s+" || Section :"+@batch.course.section_name.to_s+" || Shift :"+batch_split[0]+" || Session :"+@batch.course.session.to_s+" || Version :"+version+"
  ...
  def tabulation_failed_excell_final
    require 'spreadsheet'
    Spreadsheet.client_encoding = 'UTF-8'
    new_book = Spreadsheet::Workbook.new
    sheet1 = new_book.create_worksheet :name => 'tabulation'
    ...
    @report_data['report']['students'].each do |std|
      ...
      @report_data['report']['subjects'].each do |sub|
        ...
        grade = GradingLevel.percentage_to_grade(main_mark, @batch.id)
        if !grade.blank? and !grade.name.blank?
          if grade.credit_points.to_i == 0 || subject_failed == true
            subject_failed = true
            failed = true
            total_failed = total_failed+1
            row_first << "Failed"
  ...
  def tabulation_failed_excell_prep
    require 'spreadsheet'
    Spreadsheet.client_encoding = 'UTF-8'
    new_book = Spreadsheet::Workbook.new
    sheet1 = new_book.create_worksheet :name => 'tabulation'
  ...
  def tabulation_bncd_final_excel
    require 'spreadsheet'
    Spreadsheet.client_encoding = 'UTF-8'
    new_book = Spreadsheet::Workbook.new
    sheet1 = new_book.create_worksheet :name => 'tabulation'
  ...
  def tabulation_bncd_prep_excel
    require 'spreadsheet'
    Spreadsheet.client_encoding = 'UTF-8'
    new_book = Spreadsheet::Workbook.new
    sheet1 = new_book.create_worksheet :name => 'tabulation'
    ...
    @report_data['report']['subjects'].each do |sub|
      ...
      if has_exam == true
        row_first << "Term I CQ"
        row_first << "Term I MCQ"
        row_first << "Term II CQ"
        row_first << "Term II MCQ" 
        row_first << "TTL"
        row_first << "GP"
      end
    end 
 ...
 Program :"+@batch.course.course_name.to_s+" || Group :"+group_name.to_s+" || Section :"+@batch.course.section_name.to_s+" || Shift :"+batch_split[0]+" || Session :"+@batch.course.session.to_s+" || Version :"+version+"
  ...
  def render_connect_exam(template,for_save=false,file_name="")
    ...
    if MultiSchool.current_school.id == 246
      ...
      if (@connect_exam_obj.result_type == 8 or @connect_exam_obj.result_type == 9 or @connect_exam_obj.result_type == 10 or @connect_exam_obj.result_type == 12 or @connect_exam_obj.result_type == 14 or @connect_exam_obj.result_type == 16) and @transcript.blank?
        render :pdf => template,
      ...
      unless @tabulation_data.blank?
        ...
        @tabulation_data['report'].each do |tab|
          ...
          tab['students'].each do |std| 
            ...
            tab['subjects'].each do |sub|
              ...
              if batch_subject_id.include?(sub['id'].to_i) or std_subject_id.include?(sub['id'].to_i)
                ...
                if @connect_exam_obj.result_type == 3 or @connect_exam_obj.result_type == 4
                  if @batch.course.course_name == "One" or @batch.course.course_name == "Two"
                    term_mark_multiplier = 1
                  else
                    term_mark_multiplier = 0.8
                  end
                end
                ...
                ##  abort(total_mark1.to_s + "  " + total_sb1.to_s + "  " + monthly_total_mark1.to_s + "  " + at_total_mark1.to_s)
                #end
                ...
                if @connect_exam_obj.result_type != 5 and @connect_exam_obj.result_type != 6 and @connect_exam_obj.result_type != 1  and @connect_exam_obj.result_type != 2
                  if monthly_total_mark1 > 0
                    ...
                    monthly_total_mark1 = monthly_total_mark1
                ...
                tab['subjects'].each do |sub2|
                  ...
                  if batch_subject_id.include?(sub2['id'].to_i) or std_subject_id.include?(sub2['id'].to_i)
                    ...
                    monthly_total_main_mark1 = monthly_total_mark1
                    monthly_total_main_mark2 = monthly_total_mark2
                    if @connect_exam_obj.result_type != 5 and @connect_exam_obj.result_type != 7
                      if monthly_total_mark1 > 0
                        monthly_total_mark1 = (monthly_total_mark1/monthly_full_mark1)*monthly_mark_multiply
                        monthly_total_mark1 = monthly_total_mark1.round()
                        if @connect_exam_obj.result_type == 7 && @batch.course.course_name.upcase == "NINE"
            ...
            if std['id'].to_s == "39040"
              #abort(grand_total_with_fraction_marks.inspect)
            end
            if u_grade1 == 0
            ...
            if u_grade2 == 0
              grand_total_new = 55500-grand_total2_with_fraction
