...
<div id="primary" class="content-area">
	...
	<div class="wrapper">
		...
		<div id="beforeWrap" style="background: transparent url(<?php bloginfo('template_url'); ?>/images/cover/teacher-page.png) no-repeat bottom left;background-size:contain;">
			<!--img src="<?php bloginfo('template_url'); ?>/images/test/CLASSTUNE-COVER.png" alt="" title="" width="100%" /<li style="color:#64B846;">|</li>-->
			<h2 class="f2" style="float: left;margin-left: 100px;margin-top: 220px;text-align: right;width: 600px;clear:both;"><i>ช่วยให้แต่ละงานของคุณครูดีขึ้นอย่างไม่น่าเชื่อ!</i></h2>
			<div class="postlist-tab2">
				<div style=" position: relative;top: 48px;z-index: 1;">
					<a href="<?php echo get_site_url().'/'.$lang; ?>/signup<?php echo "-".$lang;?>?user_type=3" style="background-color: #64b846;color: #fff;font-size: 20px;padding: 20px 40px;text-decoration: none;border-radius:5px;	-moz-border-radius:5px;	-webkit-border-radius:5px;border:1px solid #fff;box-shadow: 0 4px 2px -2px gray;">
					สร้างบัญชีของคุณ ฟรี</a>
				</div>
			</div>
		</div>
		...
		<div id="cronWrap" style="background-color:#F4FAFA;background-image:none;top:500px;height:800px;">
			<div style="border: 0 solid #ccc;left: 50%;margin: 0 0 0 -499px;position: absolute;width: 1000px;padding:55px 10px 0;">
				<h2 class="f2" style="text-align:center;"><i>ตอนนี้คุณครูมุ่งเน้นได้มากกว่าเรื่องการสอน!</i></h2><br>
				<p style="font-size:16px;"><b>ClassTune</b> ถูกออกแบบมาสำหรับเพิ่มประสิทธิภาพห้องเรียนดิจิตอลของคุณ ส่งเสริมในการเชื่อมความสัมพันธ์กับนักเรียนในสภาพแวดล้อมของการเรียนรู้ ที่สำคัญไม่มีค่าใช้จ่ายสำหรับคุณครูและจะเป็นอย่างนั้นตลอดไป. </p>
                               <p style="font-size:16px;"> ทำทุกอย่างได้ภายในแพลตฟอร์มเดียว ช่วยส่งเสริมและพัฒนาการเรียนการสอนรวมไปถึงกิจกรรมอื่นๆในห้องเรียนให้มีประสิทธิภาพมากขึ้น
						...
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">								
								...
								<div class="col-sm-7">
									...
									<p>
										ปัจจุบันการเช็คชื่อนั้นยุ่งยากและเปลืองกระดาษ ClassTune ช่วยให้คุณครูสามารถเช็คชื่อเด็กนักเรียนทั้งห้องเสร็จภายใน 2 นาที ผ่านระบบดิจิตอลเพียงไม่กี่คลิก นอกจากนั้นยังมีระบบแจ้งเตือนผู้ปกครองในทันทีที่มีการเช็คชื่อลูกๆของพวกเค้า ช่วยให้คุณครูมีสมาธิมากขึ้นในกิจกรรมการเรียนการสอน.  
									</p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">เช็คชื่อนักเรียนง่ายๆ แค่แตะหน้าจอ!</h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									...
									<div class="col-sm-12"  style="margin-top:30px;">
									<p>
										คุณครูสามารถใช้ปฏิทินการศึกษา ผ่านแอพฯ ClassTune เป็นตัวช่วยในการวางแผนท่องเที่ยวในวันหยุดสุดสัปดาห์ หรือกิจรรมที่สำคัญตามความเหมาะสม.
									</p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">ไม่พลาดวันสำคัญตลอดทั้งปี</h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									...
									<div class="col-sm-12"  style="margin-top:30px;">
									<p>
										คุณครูสามารถอัพโหลด แผนการเรียนประจำสัปดาห์ ประจำเดือน หรือประจำปี เข้าสู่ระบบเพื่อไปเชื่อมต่อกับปฏิทินการศึกษา และใช้ร่วมกับนักเรียนของคุณได้ง่ายมาก. 
									</p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">อัพโหลดและแบ่งปันแผนการเรียนของคุณได้ง่ายมาก  </h3>
									</div>									
								</div>								
							</div>		
						</li>
							...
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									<div class="col-sm-12">
										...
										<div class="col-sm-8"><p class="f2" style="font-size:20px;padding: 16px 5px;"><i>ตารางสอนสำหรับคุณครู</i></p></div>
									</div>
									
									<div class="col-sm-12"  style="margin-top:30px;">
									<p>
										คุณครูสามารถดูตารางสอนได้ทั้งแบบวันต่อวัน หรือแบบทั้งสัปดาห์ หรือแม้กระทั่งตารางนัดพบผู้ปกครอง ดูตารางการใช้ห้องเรียนเพื่อหลีกเลี่ยงตารางเรียนชนกัน.
									</p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">จัดการ การเรียนการสอนได้อย่างราบลื่น</h3>
									</div>									
								</div>								
							</div>		
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									...
									<div class="col-sm-12"  style="margin-top:30px;">
									<p>
										ต่อไปนี้จะไม่มีการแจกการบ้านในสมุดพกอีกแล้ว คุณครูสามารถมอบหมายการบ้านทั้งหมดผ่าน ClassTune ได้เลย และยังกำหนดวันส่งงานได้อีกด้วย  ซึ่งการบ้านทั้งหมดจะส่งไปยังนักเรียนทั้งห้องผ่านการสั่งงานเพียงครั้งเดียว หรือจะมอบหมายเป็นงานเฉพาะนักเรียนคนใดคนหนึ่งก็ทำได้เช่นกัน. 
									</p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">มอบหมายการบ้านผ่านระบบดิจิตอล</h3>
									</div>									
								</div>								
							</div>	
						</li>
						...
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									...
									<div class="col-sm-12"  style="margin-top:30px;">
									<p>
										คุณครูและผู้ปกครองสามารถสื่อสารกันได้ง่ายผ่านแพลตฟอร์มเดียว ไม่ว่าครูเป็นฝ่ายนัดพบผู้ปกครอง หรือผู้ปกครองเป็นฝ่ายนัดพบครู ทุกอย่างมีระบบแจ้งเตือนทั้งหมด.
									</p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">การนัดพบเป็นเรื่องง่ายไปแล้ว! </h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
							<div class="col-sm-12" style="height:300px;width:1000px;">
								...
								<div class="col-sm-7">
									...
									<div class="col-sm-12"  style="margin-top:30px;">
									<p>
										ClassTune ทำให้คุณครูสามารถสร้าง แก้ไข พัฒนาและแจ้งผลสอบให้กับนักเรียนและผู้ปกครองได้ง่ายอย่างไม่เคยมาก่อน ที่สำคัญ ClassTune ยังเก็บข้อมูลรายการทั้งหมดไว้ให้ หากต้องการเรียกใช้ภายหลัง. 
									</p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">สร้างผลสอบที่ใช้งานได้อย่างมีประสิทธิภาพ</h3>
									</div>									
								</div>								
							</div>	
						</li>
						<li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                        ...
                                                        <div class="col-sm-7">
                                                                        ...
                                                                        <div class="col-sm-12"  style="margin-top:30px;">
                                                                        <p>
                                                                            สร้างและเก็บทุกกิจจรรมที่เกิดขึ้นในโรงเรียน ทำให้ทุกคนสามารถติดตามกิจกรรมที่กำลังจะเกิดขึ้นได้ง่าย.    
                                                                        </p>
                                                                        <h3 class="f2" style="font-size:20px;padding: 16px 5px;">คุณจะไม่พลาดทุกกิจกรรมเด็ดของโรงเรียนอีกแล้ว! </h3>
                                                                        </div>									
                                                        </div>								
                                                    </div>	
						</li>	
                                                ...
                                                <li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    ...
                                                                    <div class="col-sm-12"  style="margin-top:30px;">
                                                                    <p>
                                                                            อัพโหลดหลักสูตรและการสอบตามหลักสูตรแล้วแบ่งปันให้กับนักเรียนและผู้ปกครอง ซึ่งคุณครูสามารถปรับปรุงหลักสูตรได้ทุกเมื่อที่ต้องการ.  
                                                                    </p>
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;">ทุกคนสามารถดูหลักสูตรผ่านช่องทางออนไลน์</h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>	
                                                ...
                                                <li>
                                                    <div class="col-sm-12" style="height:300px;width:1000px;">
                                                            ...
                                                            <div class="col-sm-7">
                                                                    ...
                                                                    <div class="col-sm-12"  style="margin-top:30px;">
                                                                    <p>
                                                                            คุณครูสามารถยื่นขอลาได้ง่ายมาก เพียงกรอกข้อมูลลงใน ClassTune ผ่านสมาร์ทโฟนหรือคอมพิวเตอร์ และกดส่ง เสร็จแล้วรอรับการแจ้งเตือน นอกจากนั้นคุณยังใช้ในการอนุมัติการลาของนักเรียนได้อีกด้วย. 
                                                                    </p>
                                                                    <h3 class="f2" style="font-size:20px;padding: 16px 5px;">การยื่นขอลาที่สะดวกสบายมากขึ้น! </h3>
                                                                    </div>									
                                                            </div>								
                                                    </div>	
						</li>
