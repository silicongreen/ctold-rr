...
/**
 * This is the model class for table "classwork_answers".
 *
 * The followings are the available columns in table 'classwork_answers':
 * @property integer $id
 * @property integer $classwork_id
 ...
 */
class ClassworkAnswers extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('classwork_id, student_id, attachment_file_size, school_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, classwork_id, student_id, status, title, content, attachment_file_name, attachment_content_type, attachment_file_size, attachment_updated_at, created_at, updated_at, school_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('classwork_id',$this->classwork_id);
	 ...
	 * @return ClassworkAnswers the static model class
	 */
