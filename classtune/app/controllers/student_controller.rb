...
#    end
  ...
  def edit
    ...
    @elective_subjects = Subject.find_all_by_batch_id(@student.batch_id,:inlcude=>[:elective_group],:conditions=>["subjects.elective_group_id IS NOT NULL AND subjects.is_deleted = false AND elective_group.batch_id = ?",@student.batch_id])
    guardians = @student.student_guardian
