ActionController::Routing::Routes.draw do |map|
 ...
 #assignment
  map.resources :assignments,:collection=>{:add_assignment_result=>[:get,:post],:assignment_result=>[:get],:download_attachment_result=>[:get],:view_assignment_result=>[:get],:deleteassignment_result=>[:get],:download_pdf=>[:get],:download_pdf_publush_date=>[:get],:download_excell=>[:get],:get_homework_filter=>[:get],:use_homework=>[:get],:publisher=>[:get],:show_publisher=>[:get],:approved_homework=>[:get],:create_use_homwork=>[:post],:subject_assignments_approved=>[:get], :get_homework_filter_publisher=>[:get],:subject_assignments_publisher=>[:get]},:has_many => :assignment_answers
