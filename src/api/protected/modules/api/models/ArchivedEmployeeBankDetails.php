...
/**
 * This is the model class for table "archived_employee_bank_details".
 *
 * The followings are the available columns in table 'archived_employee_bank_details':
 * @property integer $id
 ...
 */
class ArchivedEmployeeBankDetails extends CActiveRecord
{
	/**
	...
	{
		return 'archived_employee_bank_details';
	}
	 ...
	 * @return ArchivedEmployeeBankDetails the static model class
	 */
