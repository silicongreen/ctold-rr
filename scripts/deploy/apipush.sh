...
echo "Syncing to UNI web root..."
rsync -aqP  $1/ /var/www/cysoco/ --exclude /storage --exclude /scripts --stats

echo "Clearing views_c"

rm -rf /var/www/cysoco/admin_settings/views_c/
mkdir -p /var/www/cysoco/admin_settings/views_c/
chown -R  cysoco: /var/www/cysoco/admin_settings/views_c/
...
chown -R cysoco: /var/www/cysoco/cache_manager/views_c/
...
chown -R cysoco: /var/www/cysoco/staff_watched/views_c/
