    ...
    if @is_class_exam
      @batches.each do |b|
        if b != this_id
          ...
          @exam_data = {"name" => @exam_group.name, "exam_category" => @exam_group.exam_category, "topic" => @exam_group.topic, "exam_type" => @exam_group.exam_type, "exam_date" => @exam_group.exam_date, "exams_attributes" => @exam_attributes}
...
#    end
    ...
    if @is_class_exam
      ...
      @exam_data = {"name" => params[:exam_group][:name], "exam_category" => params[:exam_group][:exam_category], "topic" => params[:exam_group][:topic], "exam_type" => params[:exam_group][:exam_type], "maximum_marks" => params[:exam_group][:maximum_marks], "minimum_marks" => params[:exam_group][:minimum_marks], "exams_attributes" => @exam_attributes}
    else
      @exam_data = {"name" => params[:exam_group][:name], "exam_category" => params[:exam_group][:exam_category], "topic" => params[:exam_group][:topic], "exam_type" => params[:exam_group][:exam_type], "maximum_marks" => params[:exam_group][:maximum_marks], "minimum_marks" => params[:exam_group][:minimum_marks], "exams_attributes" => params[:exam_group][:exams_attributes]}
    end
