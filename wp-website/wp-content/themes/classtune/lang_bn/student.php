...
<div class="container"><div class="container">
	<div class="wrapper">
		...
		<div id="beforeWrap" style="background: transparent url(<?php bloginfo('template_url'); ?>/images/cover/student-page.png) no-repeat top left;background-size:cover;">
			<!--img src="<?php bloginfo('template_url'); ?>/imagestest/CLASSTUNE-COVER.png" alt="" title="" width="100%" /<li style="color:#64B846;">|</li>-->
			<h2 class="f2" style="float: right;margin-right: 120px;margin-top: 150px;width: 300px;clear:both;"><i>আপনার কাজের গতি বাড়িয়ে তুলুন!</i></h2>
