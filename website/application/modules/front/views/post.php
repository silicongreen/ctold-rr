...
<!--		<ins class="adsbygoogle"
    ...
    <style>
        ...
        .suggested-post-container .action-box .seen-image {
            float: left;
            margin-left: 5px !important;
            margin-top: 5px !important;
            width: 15%;
        }
        .suggested-post-container .action-box .seen-image img {
            margin-left: 5px !important;
        }
        .suggested-post-container .action-box .seen {
            float: left;
            margin-top: 12px !important;
            width: 74.667%;
        }
        .suggested-post-container .action-box .seen span {
            font-size: 10px;
            margin-top: 0 !important;
        }
        .suggested-post-container .action-box .addthis_toolbox {
            border: medium none;
            border-radius: 0;
            height: 40px;
        }
        .suggested-post-container .action-box .read_later {
        ...
        #demo2 .als-next {
            background: transparent url("../styles/layouts/tdsfront/images/nextarrow.png") no-repeat scroll 0 0;
            margin-left: 5px;
