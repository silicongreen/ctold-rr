...
<?php $date = (isset($_GET['date']) && strlen($_GET['date']) != "0") ? $_GET['date'] : date('Y-m-d'); ?>
            <div id="dp6" data-date="<?php echo $date; ?>" data-date-format="yyyy-mm-dd"></div>
            <?php if (isset($_GET['date']) && strlen($_GET['date']) != "0") : ?>
            ...
            <p>
                <b>Powered By</b> 
                <a href="http://www.champs21.com" target="_blank">
                    <img src="<?php echo base_url() ?>styles/layouts/tdsfront/images/champs21_footer.jpg" alt="champs21.com" width="90%" style="border: none;" />
                </a>
            <p>
...
<?php
$s_script = "http://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js";
?>
<!--<script async src="<?php echo base_url('front/home/get_external_scripts?script=' . $s_script) ?>"></script>-->
