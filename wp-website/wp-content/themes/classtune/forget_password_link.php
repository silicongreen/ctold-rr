 ...
 */
/*
  Template Name: forget_password_link
 */
get_header();
?>
                        ...
                        <div style="margin:30px 100px; float:left; width:80%;background: white; ">
                            ...
                            <div class="col-md-12"  style="padding:0px; ">
                                <h2 class="lead text-center editContent"  style="color:#66D56A; font-weight: bold;margin-top: 20px;">
                                    <iframe id="iframe_change_height"  src="http://www.champs21.com/front/paid/forget_password_link?token=<?php echo $_GET['token']; ?>" style="border:1px solid white" style="border:0;" width="100%" scrolling="no"></iframe>
                                </h2>
                            </div>
