    ...
    <div id="wrapper" data-adminica-nav-top="1" data-adminica-side-top="1">
        ...
        <div id="main_container" class="main_container container_16 clearfix">
            ...
            <div class="box grid_16" >
                ...
                $filter_array[1] = array("Columnist", "form_dropdown", $status);
            ...
            <?php if(access_check("bylines","add")): ?>
            <div class="flat_area grid_16">
                <button  type="button"  class="light text_only has_text model" id="<?php echo  base_url(); ?>admin/bylines/add/" >
                    <span>Add Byline</span>
                </button>
            </div> 
            <?php endif; ?>
